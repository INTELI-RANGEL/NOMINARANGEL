...
uses
frm_ordenes, frm_EmpleadosGuardias, frm_ordenesctrlobra, frm_isometricos;
{$R *.dfm}
...
begin
  ...
  try
      ...
      Try
         frmIsometricos.plataformas.Refresh;
         frmIsometricos.tsIdPlataforma.KeyValue := sId;
         frmIsometricos.tsIdPlataforma.SetFocus;
      Except
      end;
