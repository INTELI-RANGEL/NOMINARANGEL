...
type
  TfrmGrupoFamilias = class(TForm)
    ...
    qryGruposFamiliassIdFamilia: TWideStringField;
    qryGruposFamiliassDescripcion: TWideStringField;
    ...
    Pegar1: TMenuItem;
    Label1: TLabel;
    dbchkAsignacion: TDBCheckBox;
    qryGruposFamiliasiAplicaEquipo: TWideStringField;
    frmtsclr1: TFormAutoScaler;
    chkInformes: TDBCheckBox;
    qryGruposFamiliasiAplicaConcentrado: TWideStringField;
