...
begin
    ...
    zQCuentasBancarias.Params.ParamByName('Cuenta').asString := PgEgresos.Pages[pgEgresos.ActivePageIndex].Caption ;
    zQCuentasBancarias.Params.ParamByName('FechaI').asDate   := tdFechaInicio.Date ;
    zQCuentasBancarias.Params.ParamByName('FechaF').asDate   := tdFechaFinal.Date ;
    ...
    zQTesoreriaEgresos.Params.ParamByName('Cuenta').AsString := PgEgresos.Pages[pgEgresos.ActivePageIndex].Caption ;
    zQTesoreriaEgresos.Params.ParamByName('FechaI').asDate   :=  tdFechaInicio.Date;
    zQTesoreriaEgresos.Params.ParamByName('FechaF').AsDate   :=  tdFechaFinal.Date ;
...
begin
  ...
  AColumn := (Sender as TcxGridDBTableView).GetColumnByFieldName('sTipoMovimiento');
  BColumn := (Sender as TcxGridDBTableView).GetColumnByFieldName('lComprobado');
