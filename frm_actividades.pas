...
uses frm_GraficaGerencial, frm_GraficaGerencialDX, UnitValidaTexto,
  UFunctionsGHH, Frm_ProgramacionPartidasCia, frm_ordenesctrlobra;
...
procedure TfrmActividades.FormActivate(Sender: TObject);
begin
...
procedure TfrmActividades.btn1Click(Sender: TObject);
begin
  if not MostrarVentana('frmOrdenesCtrolObra') Then
  begin
...
procedure TfrmActividades.cxgrdbtblvwGrid1DBTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
var
