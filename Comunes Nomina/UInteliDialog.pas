...
const
  IDTituloError = 'Ha ocurrido un error inesperado';
  IDLabelError = 'Informe de lo siguiente al administrador del sistema: ' + #10 + #10;
...
begin
  ...
  PlaySound(PWideChar(LocSoundName), hInstance, SND_RESOURCE or SND_SYNC or SND_NOWAIT);
