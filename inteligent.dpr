...
uses
  ...
  frm_catalogonacionalidades in 'frm_catalogonacionalidades.pas' {frmCatalogoNacionalidades},
  ...
  frm_TiposMovC_Guardia in 'frm_TiposMovC_Guardia.pas' {frmTiposMovC_Guardia},
  UFrmRequisicionesGlobales in 'UFrmRequisicionesGlobales.pas' {FrmRequisicionesGlobales},
  ExportaExcel in 'ExportaExcel.pas',
  frm_indirecto_grupo in 'frm_indirecto_grupo.pas' {frmIndirectoGrupo},
  frm_RecepciondeMateriales in 'frm_RecepciondeMateriales.pas' {frmRecepcionDeMateriales},
  frm_ReportesAlmacen2 in 'frm_ReportesAlmacen2.pas' {frmReportesAlmacen2},
  frm_ReportesAlmacen in 'frm_ReportesAlmacen.pas' {frmReportesAlmacen},
  frm_ParamsFichaTecnica in 'frm_ParamsFichaTecnica.pas' {FrmParamsFichaTecnica},
  Frm_Resguardo in 'Frm_Resguardo.pas' {FrmResguardo},
  Frm_SetupMail in 'Frm_SetupMail.pas' {FrmSetupMail},
  Frm_ExportPDF in 'Frm_ExportPDF.pas' {FrmExportPdf},
  Frm_SendMail in 'Frm_SendMail.pas' {FrmSendMail},
  Frm_EstatusOrdenCompra in 'Frm_EstatusOrdenCompra.pas' {FrmEstatusOrdenCompra},
  DebenuPDFLibrary in '2007-DebenuPDFLibrary\DebenuPDFLibrary.pas',
  UDosCapas in 'UDosCapas.pas',
  frm_WizardContrato in 'frm_WizardContrato.pas' {frmWizard},
  frm_SubFamProductos in 'frm_SubFamProductos.pas' {frmSubFamProductos};
...
begin
  ...
  Application.Title := 'Sistema Inteligente de Administración de Contratos';
