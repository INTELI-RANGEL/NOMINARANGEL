...
uses
  ...
  masUtilerias, cxContainer, cxCheckBox, cxDBEdit, FormAutoScaler, cxTextEdit,
  cxMemo, UDosCapas, UInteliDialog;
...
type
  tfrmAlmacenes = class(TForm)
    ...
    Label4: TLabel;
    Almacenes: TZQuery;
    AlmacenessIdAlmacen: TWideStringField;
    AlmacenessCiudad: TWideStringField;
    AlmacenessCp: TWideStringField;
    AlmacenessTelefono: TWideStringField;
    AlmacenessDescripcion: TWideStringField;
    AlmacenessDireccion: TWideStringField;
    AlmacenessFax: TWideStringField;
    AlmacenessComentarios: TWideStringField;
    ...
    zqAlmaceneslPrincipal: TWideStringField;
