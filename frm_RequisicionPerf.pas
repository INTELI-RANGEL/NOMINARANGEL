...
type
  TfrmRequisicionPerf = class(TForm)
    ...
    ReportesNumeroActividad: TWideStringField;
    ...
    ReportesRequisita: TWideStringField;
    ReportesRevision: TWideStringField;
    ReportesSolicito: TWideStringField;
    ReportesStatus: TWideStringField;
    ReportesAutorizo: TWideStringField;
    ReportesVerificacion: TWideStringField;
    ReportesRecibido: TWideStringField;
    ReportesidDepartamento: TWideStringField;
    ReportesMotivo: TWideStringField;
    ReportesEstado: TWideStringField;
    ReportesLugarEntrega: TWideStringField;
    ReporteiItemOrden: TWideStringField;
    Reporteesi: TWideStringField;
    Reporteeno: TWideStringField;
    Reportedepartamento: TWideStringField;
    Reportelugarentrega: TWideStringField;
    Reportedestino: TWideStringField;
    btnProveedores: TBitBtn;
    btnReferencia: TBitBtn;
    btnDepartamento: TBitBtn;
    ReportesIdInsumo: TWideStringField;
    dbrgPrioridad: TDBRadioGroup;
    tmObsUrgencia: TDBMemo;
    Label2: TLabel;
    ReportesNumFolio: TWideStringField;
    ReportesPrioridad: TWideStringField;
    ReportesModelo: TWideStringField;
    ReportesMarca: TWideStringField;
    ReportemObsUrgencia: TMemoField;
    SolicituddeResguardo1: TMenuItem;
    DBCheckBox1: TDBCheckBox;
    Reportedexistencia: TFloatField;
    ReporteCargoAutorizo: TWideStringField;
    ReporteAutorizoR: TWideStringField;
    ...
    ReportesNumeroserie: TWideStringField;
    cxGridDBTableView1Column1: TcxGridDBColumn;
    anexo_prequisicionsContrato: TWideStringField;
    anexo_prequisicioniFolioRequisicion: TWideStringField;
    anexo_prequisicionsIdInsumo: TWideStringField;
    ...
    anexo_prequisicionsMedida: TWideStringField;
    ...
    anexo_prequisicionsModelo: TWideStringField;
    anexo_prequisicionsWbs: TWideStringField;
    anexo_prequisicionsNumeroActividad: TWideStringField;
    anexo_prequisicionsNumeroOrden: TWideStringField;
    anexo_prequisicionsObservacion: TWideStringField;
    anexo_prequisicionsEstado: TWideStringField;
    anexo_prequisicionsIdAlmacen: TWideStringField;
    anexo_prequisicionsEstatus: TWideStringField;
    anexo_prequisicionsMedidaAnexo: TWideStringField;
    anexo_prequisiciondCantidad_1: TFloatField;
    anexo_prequisicioniItemOrden: TWideStringField;
    anexo_prequisiciondExistencia: TFloatField;
    anexo_prequisiciondMontoMM: TFloatField;
    anexo_prequisicionsDescripcion: TWideStringField;
    ...
    ts1: TcxTextEdit;
    zqconsumiblessNumeroActividad: TWideStringField;
    zqconsumiblessIdInsumo: TWideStringField;
    zqconsumiblessDescripcion: TWideStringField;
    fltfldconsumiblesdCostoMN: TFloatField;
    fltfldconsumiblesdCantidad: TFloatField;
    zqconsumiblessMedida: TWideStringField;
    zqconsumiblesalmacen: TWideStringField;
    zqconsumiblessIdAlmacen: TWideStringField;
    ...
    ReportelCertificados: TWideStringField;
    ReportelHojas: TWideStringField;
    Reportemreferencia: TMemoField;
    ReporteCargoSolicito: TWideStringField;
    frmBarra1: TfrmBarra;
    ...
    Spl1: TcxSplitter;
    ReportesIdFamilia: TWideStringField;
    ReporteFamilia: TWideStringField;
...
begin
 ...
 BotonPermiso := TBotonesPermisos.Create(Self, connection.zConnection, global_grupo, sMenuP, PopupPrincipal);
 Departamentos.Active := False ;
 Departamentos.SQL.Clear ;
 if connection.configuracion.FieldByName('sConfConsecutivo').AsString ='GENERAL' then
     Departamentos.SQL.Add('Select d.sIdDepartamento,d.sDescripcion, d.nConsecutivo, d.sCadenaTexto From departamentos d Order by d.sDescripcion') ;

 if (connection.configuracion.FieldByName('sConfConsecutivo').AsString = 'CONTRATOS-DEPTOS') or (connection.configuracion.FieldByName('sConfConsecutivo').AsString = 'DEPARTAMENTOS') Then
    begin
      Departamentos.SQL.Add('Select d.sIdDepartamento,d.sDescripcion, d.nConsecutivo, d.sCadenaTexto,f.nConsecutivo as nConsecutivof, ' +
                       'f.sCadenaTexto as sCadenaTextof, f.sCadenaTextoAnexo, f.nConsecutivoAnexo From departamentos d ' +
                       'left join foliodepartamento f on (f.sIdDepartamento=d.sIdDepartamento and f.sContrato=:Contrato) ') ;
...
begin
    ...
    Begin
      ...
      Connection.QryBusca.Active := False;
      Connection.QryBusca.SQL.Clear;
      Connection.QryBusca.SQL.Add('select sIdInsumo from anexo_prequisicion where sContrato =:Contrato and iFolioRequisicion =:Folio and sIdInsumo =:Insumo ');
      Connection.QryBusca.Params.ParamByName('Contrato').DataType := ftString;
      Connection.QryBusca.Params.ParamByName('Contrato').value := Global_Contrato;
      ...
      Connection.QryBusca.Params.ParamByName('Insumo').value := Consumibles.FieldValues['sIdInsumo'] ;
      Connection.QryBusca.Open;
      ...
      begin
        ...
        begin
         ...
         if messageDLG('El Materiale ya se encuenta registrado, ¿Desea actualizar la cantidad y Fecha? ', mtConfirmation, [mbYes,mbNo], 0)=mrYes then
         begin
            Connection.QryBusca.Active := False;
            Connection.QryBusca.SQL.Clear;
            Connection.QryBusca.SQL.Add('UPDATE anexo_prequisicion SET dFechaRequerimiento = :Requerido, dCantidad = :Cantidad where sContrato =:Contrato and iFolioRequisicion =:Folio and sIdInsumo =:Insumo ');
            Connection.QryBusca.Params.ParamByName('Contrato').DataType := ftString;
            Connection.QryBusca.Params.ParamByName('Contrato').value := Global_Contrato;
            Connection.QryBusca.Params.ParamByName('Folio').DataType := ftString;
            Connection.QryBusca.Params.ParamByName('Folio').value :=anexo_requisicion.FieldValues['sNumFolio'] ;
            ...
            Connection.QryBusca.Params.ParamByName('Requerido').value     := tdFechaRequerimiento.Date ;
            Connection.QryBusca.Params.ParamByName('Cantidad').DataType   := ftFloat ;
            Connection.QryBusca.Params.ParamByName('Cantidad').value      := tdCantidad.Value ;
...
begin
  try
    ...
    tsDepartamento.KeyValue:=Connection.qryBusca.FieldByName('sIdDepartamento').Value;
            ...
            Aux2 := departamentos.FieldByName('nConsecutivo').AsInteger ;
                  ...
                  if Connection.configuracion.FieldByName('sConfConsecutivo').AsString = 'GENERAL' Then
                    begin
                        if ( Connection.configuracion.fieldByName('iAlmConsecutivoReq').AsInteger + 1)  < connection.QryBusca.FieldByName( 'iFolioRequisicion' ).AsInteger then
                           ...
                           FolioR := formatfloat(Numdigitos,Maximo)  + Connection.configuracion.FieldByName('sPrefijoReq').AsString;
                    end ;

                  if Connection.configuracion.FieldByName('sConfConsecutivo').AsString = 'DEPARTAMENTOS' Then
                     begin
                           Aux2 := departamentos.FieldByName('nConsecutivo').AsInteger + 1;
                           FolioR := formatfloat(Numdigitos,Aux2) + departamentos.FieldByName('sCadenaTexto').AsString;
                           Maximo := connection.QryBusca.FieldByName( 'iFolioRequisicion' ).AsInteger + 1;
                     end  ;

                     If Connection.configuracion.FieldByName('sConfConsecutivo').AsString = 'CONTRATOS-DEPTOS' Then
                     begin
                       if anexo_requisicion.FieldByName('lTipoReq').AsString ='CONSUMIBLES' then
                          begin
                            Aux2 := departamentos.FieldByName('nConsecutivof').AsInteger + 1;
                            FolioR := formatfloat(Numdigitos,Aux2) + departamentos.FieldByName('sCadenaTextof').AsString;
                          end;
                       if anexo_requisicion.FieldByName('lTipoReq').AsString ='ANEXO' then
                          begin
                            Aux2 := departamentos.FieldByName('nConsecutivoAnexo').AsInteger + 1;
                            FolioR := formatfloat(Numdigitos,Aux2) + departamentos.FieldByName('sCadenaTextoAnexo').AsString;
                          end;
              ...
              connection.zCommand.ExecSQL;
               ...
               begin
                 ...
                 if anexo_requisicion.FieldByName('lTipoReq').AsString ='ANEXO' then
                     connection.zCommand.SQL.Text := 'Update foliodepartamento set nConsecutivoAnexo = :valor Where sContrato=:Contrato and sIdDepartamento =:IdDepto';
...
procedure TfrmRequisicionPerf.btnAddClick(Sender: TObject);
begin
Try
...
procedure TfrmRequisicionPerf.btnDeleteClick(Sender: TObject);
Var
  SavePlace : TBookmark;
begin
    validaciones;
...
procedure TfrmRequisicionPerf.btnEditClick(Sender: TObject);
begin
   validaciones;
    if valida then
    begin
...
procedure TfrmRequisicionPerf.PgControlChanging(Sender: TObject;
