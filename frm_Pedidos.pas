...
uses
  ...
  cxRichEdit, ZSqlUpdate, cxCheckBox;
...
type
  TfrmPedidos = class(TForm)
    ...
    anexo_pocomprassContrato: TWideStringField;
    anexo_pocomprasdCantidad: TFloatField;
    anexo_pocomprasiFolioPedido: TIntegerField;
    anexo_pocomprassNumeroActividad: TWideStringField;
    anexo_pocomprasiItem: TIntegerField;
    anexo_pocomprasmDescripcion: TMemoField;
    anexo_pocomprassMedida: TWideStringField;
    frxEntrada: TfrxReport;
    anexo_pocomprassIdInsumo: TWideStringField;
    anexo_pocomprasdCosto: TFloatField;
    anexo_pocomprassNumeroOrden: TWideStringField;
    anexo_pocomprassDescripcion: TWideStringField;
    ...
    rxSeguimiento_MatsContrato: TWideStringField;
    rxSeguimiento_MatPartida: TWideStringField;
    rxSeguimiento_MatsNumeroActividad: TWideStringField;
    rxSeguimiento_MatDescripcionAnexo: TWideStringField;
    rxSeguimiento_MatCantidadAnexo: TFloatField;
    rxSeguimiento_MatMedidaAnexo: TWideStringField;
    rxSeguimiento_MatCostoMNAnexo: TFloatField;
    rxSeguimiento_MatCostoDLLAnexo: TFloatField;
    rxSeguimiento_MatTipo: TWideStringField;
    rxSeguimiento_MatId: TWideStringField;
    rxSeguimiento_MatDescripcion: TWideStringField;
    rxSeguimiento_MatUnidad: TWideStringField;
    ...
    rxSeguimiento_MatNumeroReporte: TWideStringField;
    rxSeguimiento_MatFechaRD: TDateField;
    rxSeguimiento_MatFrenteRD: TWideStringField;
    ...
    rxSeguimiento_MatsNumeroOrden: TWideStringField;
    rxSeguimiento_MatsNumeroGenerador: TWideStringField;
    ...
    rxSeguimiento_Mat1Unidad: TWideStringField;
    ...
    anexo_pocomprassStatus: TWideStringField;
    ...
    rxPreciossContrato: TWideStringField;
    rxPreciossIdInsumo: TWideStringField;
    rxPreciosmDescripcion: TMemoField;
    rxPreciossIdProveedor: TWideStringField;
    ...
    rxPreciossOrdenCompra1: TWideStringField;
    rxPreciossOrdenCompra2: TWideStringField;
    rxPreciossOrdenCompra3: TWideStringField;
    rxPreciossOrdenCompra4: TWideStringField;
    rxPreciossOrdenCompra5: TWideStringField;
    rxPreciossOrdenCompra6: TWideStringField;
    rxPreciossOrdenCompra7: TWideStringField;
    rxPreciossOrdenCompra8: TWideStringField;
    frmBarra2: TfrmBarra;
    ...
    anexo_ocomprassContrato: TWideStringField;
    anexo_ocomprasiFolioPedido: TIntegerField;
    anexo_ocomprassOrdenCompra: TWideStringField;
    anexo_ocomprassFolioRequisicion: TWideStringField;
    anexo_ocomprassIdProveedor: TWideStringField;
    anexo_ocomprassNumeroOrden: TWideStringField;
    anexo_ocomprasdIdFecha: TDateField;
    anexo_ocomprasdFechaEntrega: TDateField;
    anexo_ocomprassReferencia: TWideStringField;
    anexo_ocomprassElaboro: TWideStringField;
    anexo_ocomprassReviso1: TWideStringField;
    anexo_ocomprassReviso2: TWideStringField;
    anexo_ocomprassAutorizo: TWideStringField;
    anexo_ocomprassMedioTransporte: TWideStringField;
    anexo_ocomprasiPeriodoPago: TIntegerField;
    anexo_ocompraslUnicoProveedor: TWideStringField;
    anexo_ocomprassMoneda: TWideStringField;
    anexo_ocomprasdCambio: TFloatField;
    anexo_ocomprasmComentarios: TMemoField;
    anexo_ocomprassStatus: TWideStringField;
    anexo_ocomprassLugarEntrega: TWideStringField;
    anexo_ocomprassCondiciones: TWideStringField;
    anexo_ocomprasdIVA: TFloatField;
    anexo_ocomprasdDescuento: TFloatField;
    anexo_ocomprassEntrega: TWideStringField;
    anexo_ocomprassPrecios: TWideStringField;
    anexo_ocomprassVigencia: TWideStringField;
    anexo_ocomprassVendedor: TWideStringField;
    anexo_ocomprassMail: TWideStringField;
    anexo_ocompraseEntregado: TWideStringField;
    ...
    zq_ocomprassdireccionEnviar: TWideStringField;
    zq_ocomprassCiudadEnviar: TWideStringField;
    zq_ocomprassTelefonoEnviar: TWideStringField;
    frmtsclr1: TFormAutoScaler;
    zqFormasPago: TZReadOnlyQuery;
    dsFormasPago: TDataSource;
    zqanexo_ocomprassFormaPago: TWideStringField;
    ...
    zqanexo_ocomprasTituloProveedor: TWideStringField;
    zqanexo_ocomprasTituloFormaPago: TWideStringField;
    zqanexo_ocomprasTituloMoneda: TWideStringField;
    ...
    Label1: TLabel;
    edtIsr: TRxCalcEdit;
    anexo_ocomprasdIsr: TFloatField;
    Label2: TLabel;
    edtIsrIva: TRxCalcEdit;
    anexo_ocomprasdIsrIVa: TFloatField;
    Grid_InsumosPendiente: TcxGridDBColumn;
    UdSqlanexo_pocompras: TZUpdateSQL;
    anexo_pocomprasAplicaIva: TWideStringField;
    col_aplicaIva: TcxGridDBColumn;
    ...
    procedure edtIsrEnter(Sender: TObject);
    procedure edtIsrExit(Sender: TObject);
    procedure edtIsrKeyPress(Sender: TObject; var Key: Char);
    procedure edtIsrIvaEnter(Sender: TObject);
    procedure edtIsrIvaExit(Sender: TObject);
    procedure edtIsrIvaKeyPress(Sender: TObject; var Key: Char);
  ...
  private
    ...
    function DeletePdasReq(ParamReq:String):Boolean;
  public
    { Public declarations }
  end;
...
var
  ...
  sBackup: string;
  MontoTotal,MontoSinIva: Currency;
...
function TfrmPedidos.DeletePdasReq(ParamReq:String):Boolean;
var
  QrPdasReq:TZReadOnlyQuery;
begin
  QrPdasReq:=TZReadOnlyQuery.Create(nil);
  try
    QrPdasReq.Connection:=connection.zConnection;
   // QrPdasReq.SQL.Text:='select app.* from anexo_ppedido app '+
...
begin
  ...
  begin
    ...
    insumos.SQL.Clear;
    insumos.SQL.Add('SELECT '' as Requisicion,a.sIdInsumo, a.sIdAlmacen, a.sMedida, a.mDescripcion, a.dVentaDLL, a.dVentaMN, a.dCantidad, a.dNuevoPrecio, ');
    insumos.SQL.Add('SubStr(mDescripcion, 1, 255) as sDescripcion, "" as Requisicion , b.sDescripcion as Almacen, a.dExistencia, 0.00 as pendiente ');
...
begin
 ...
 if tDescuentoMat.Value > (tdCantidad.Value * tdCostoNuevo.Value) then
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Connection.zcommand.Params.ParamByName('item').AsInteger:= insumos.FieldByNAme('iItem').AsInteger;
      ...
      begin
        ...
        Connection.zcommand.Params.ParamByName('item').AsInteger:= 1;
      end;
  ...
  begin
    ...
    nReco:=NumItems(dbRequisicion.Text,',');
  ...
  sReco:string;    }
    ...
    repeat
      ...
      if nReco=0 then
        sReco:=dbRequisicion.Text
      else
        sReco:= TraerItem(dbRequisicion.Text,',',PosReco);

      connection.QryBusca.Close;
      connection.QryBusca.SQL.Text:='select sum(app.dcantidad) as total,apr.dCantidad from anexo_ppedido app' + #13#10 +
                                    'inner join anexo_pedidos ap' + #13#10 +
                                    'on(ap.sContrato=app.sContrato and ap.iFolioPedido=app.iFolioPedido)' + #13#10 +
                                    'inner join anexo_requisicion ar' + #13#10 +
                                    'on(ar.sContrato=ap.sContrato and Find_In_Set(ar.sNumfolio,ap.sFolioRequisicion))' + #13#10 +
                                    'inner join anexo_prequisicion apr' + #13#10 +
                                    'on(ar.sContrato=apr.sContrato and ar.sNumFolio=apr.iFolioRequisicion and app.sIdInsumo=apr.sIdInsumo)' + #13#10 +
                                    'where ap.sContrato=:Contrato and ar.sNumfolio=:Folio and app.sidinsumo=:Insumo' ;
      connection.QryBusca.ParamByName('contrato').AsString:=Global_Contrato;
      connection.QryBusca.ParamByName('Folio').AsString:= sReco;//anexo_ocompras.FieldValues['sFolioRequisicion'];
      connection.QryBusca.ParamByName('Insumo').AsString:=insumos.FieldValues['sIdInsumo'];
      connection.QryBusca.Open;
      if  (connection.QryBusca.RecordCount=1) and
          ((not connection.QryBusca.FieldByName('dCantidad').IsNull) and (connection.QryBusca.FieldByName('total').AsFloat>=connection.QryBusca.FieldByName('dCantidad').AsFloat))
      then
      begin
        Connection.zCommand.Active := False;
        Connection.zCommand.SQL.Clear;
        ...
        Connection.zcommand.Params.ParamByName('Folio').value :=sReco;// anexo_ocompras.FieldValues['sFolioRequisicion'];
        Connection.zcommand.Params.ParamByName('Insumo').DataType := ftString;
        Connection.zcommand.Params.ParamByName('Insumo').value := insumos.FieldValues['sIdInsumo'];
        Connection.zcommand.Params.ParamByName('Item').DataType := ftInteger;
      ...
      Connection.zcommand.Params.ParamByName('Contrato').value := Global_Contrato;
      Connection.zcommand.Params.ParamByName('Folio').DataType := ftString;
      Connection.zcommand.Params.ParamByName('Folio').value := sReco;// insumos.FieldValues['Requisicion'];
...
begin
  ...
  begin
    if anexo_ocompras.FieldValues['sFolioRequisicion'] <> '' then
      tdCantidad.Value := insumos.FieldValues['pendiente']
    else
      tdCantidad.Value := 0;
...
if connection.configuracion.FieldByName('sContacto').AsString ='Proveedores' then
   begin
...
begin
  try
     ...
     Connection.qryBusca.Open;
     if Connection.qryBusca.RecordCount > 0 then
       MontoSinIva := Connection.qryBusca.fieldValues['dMontoMN']-anexo_ocompras.FieldValues['dDescuento'];
     ...
     dIVA := (anexo_ocompras.FieldByNAme('dIVA').asfloat / 100);

     frxEntrada.Variables.Variables['MONTOIVA']:= roundto(Montototal * dIVA, -2) ;
     ...
     if not FileExists(global_files + global_miReporte + '_ALMOrdCompra.fr3') then
      ...
      frxentrada.ShowReport; //(connection.configuracion.FieldByName('sFormatos').AsString, PermisosExportar(connection.zConnection, global_grupo, stMenu));
    except
      on e: exception do begin
        UnitExcepciones.manejarExcep(E.Message, E.ClassName, 'Ordenes de Compra de Materiales', 'Al imprimir', 0);
      end;
...
var
  Posicion, x, i,iTmp: Integer;
  cadena, cad, texto,CadTmp: string;
  nombres, cadenas: TStringList;
  RequisicionesSeleccionadas: TStringList;
  sPartidasDuplicadas: string;
  sIFolio: string;
  Maximo : integer;
  FolioR, Numdigitos,sDbRequisicion: string;
...
begin
  ...
  try
    ...
    begin
      ...
      {if (cadenaReq<>'') and ((cadenaReq<>dbRequisicion.Text))  then
      begin
        sDbRequisicion:=dbRequisicion.Text;
        dbRequisicion.Text:=cadenaReq;
        for ITmp := 1 to NumItems(cadenaReq,',') do
        begin
          CadTmp:=TraerItem(cadenaReq,',',iTmp);
          if CadTmp<>'' then
           if not AnsiContainsText(sDbRequisicion,CadTmp) then
      ...
      begin
        try
          ...
          zcommand.SQL.Add('INSERT INTO anexo_pedidos ( sContrato, iFolioPedido, sOrdenCompra, sIdProveedor, sNumeroOrden, dIdFecha, ' +
            'sReferencia,  mComentarios, sFolioRequisicion, sFormaPago, sMoneda, dCambio, dIVA, sElaboro, sLugarEntrega, sCondiciones, '+
            'sEntrega, ' +
            'sPrecios, sVigencia, sVendedor, sMail, dDescuento, sDireccionEnviar, sCiudadEnviar, sTelefonoEnviar, dFechaEntrega, dIsr, dIsrIva ) ' +
            'VALUES (:Contrato, :Pedido, :oCompra, :Proveedor, :Orden, :Fecha, :Orden, :Comentarios, :Requisicion, :sPago, :Moneda, :Cambio, :IVA, :Elaboro, ' +
            ':Lugar, :Condiciones, :Entrega, :Precios, :Vigencia, :Vendedor, :Mail, :Descuento, :DirecEnviar, :CiudadEnviar, :TelefonoEnviar, ' +
            ':FechaEntrega, :Isr, :IsrIva )');
          zcommand.Params.ParamByName('Contrato').DataType     := ftString;
          zcommand.Params.ParamByName('Contrato').value        := Global_Contrato;
          ...
          zcommand.Params.ParamByName('Isr').DataType          := ftFloat;
          zcommand.Params.ParamByName('Isr').value             := edtIsr.Value;

          zcommand.Params.ParamByName('IsrIva').DataType          := ftFloat;
          zcommand.Params.ParamByName('IsrIva').value             := edtIsrIva.Value;
        ...
        begin
          try
            ...
            zcommand.SQL.Add('UPDATE anexo_pedidos SET sOrdenCompra = :oCompra, sIdProveedor = :Proveedor, dIdFecha = :Fecha, ' +
              'sFormaPago = :sPago, sEntrega = :Entrega, sMoneda = :Moneda, dCambio =:Cambio, dIVA =:IVA, sLugarEntrega =:Lugar, '+
              'sCondiciones =:Condiciones, sPrecios =:Precio, sVigencia =:Vigencia, ' +
              'sNumeroOrden = :Orden, sReferencia = :Orden, mComentarios = :Comentarios, sFolioRequisicion = :Requisicion, sVendedor =:Vendedor, '+
              'sMail =:Mail, dDescuento =:Descuento, dIsr =:Isr, dIsrIva =:IsrIva, ' +
              'sDireccionEnviar =:DirecEnviar, sCiudadEnviar =:CiudadEnviar, sTelefonoEnviar =:TelefonoEnviar, dFechaEntrega =:Fechas ' );
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if insumos.FieldByName('dNuevoPrecio').AsFloat=0 then
          tdCostoNuevo.Value :=insumos.FieldByName('dVentaMn').AsFloat
        else
          tdCostoNuevo.Value := insumos.FieldValues['dNuevoPrecio'];
      end;
    end;
...
begin
  ...
  begin
    ...
    if Insumos.RecordCount>0 then
    begin
      if Insumos.FieldByName('requisicion').AsString<>'' then
        if tdCantidad.Value>Insumos.FieldByName('pendiente').AsFloat then
        begin
            if messageDLg('Se excede el limite de compra. ' + #13 + #10 +
            '¿Desea continuar con esa cantidad?', mtWarning, [mbYes,mbNo], 0) = mrNo then
            begin
              InputDirect:=False;
              tdCantidad.Value:=Insumos.FieldByName('pendiente').AsFloat;
              InputDirect:=True;
            end;
...
procedure TfrmPedidos.pgcontrolChanging(Sender: TObject;
  var AllowChange: Boolean);
begin
  AllowChange:=True;
  if anexo_ocompras.State in [dsInsert,dsEdit] then
    AllowChange:=False;
end;
...
begin
  try
    ...
    insumos.SQL.Add('select a.iFolioRequisicion as Requisicion, a.dCantidad as dCantidad, i.*, SubStr(i.mDescripcion, 1, 255) as sDescripcion, a.iItem, '+
      ' a.sNumeroActividad, alm.sDescripcion AS Almacen ,'   +
      'a.dCantidad - Ifnull((select sum(app.dcantidad) as total from anexo_ppedido app' + #13#10 +
                                    'inner join anexo_pedidos ap' + #13#10 +
                                    'on(ap.sContrato=app.sContrato and ap.iFolioPedido=app.iFolioPedido)' + #13#10 +
                                    'inner join anexo_requisicion ar' + #13#10 +
                                    'on(ar.sContrato=ap.sContrato and FIND_IN_SET(ar.sNumfolio,ap.sFolioRequisicion))' + #13#10 +
                                    'inner join anexo_prequisicion apr' + #13#10 +
                                    'on(ar.sContrato=apr.sContrato and ar.sNumFolio=apr.iFolioRequisicion and app.sIdInsumo=apr.sIdInsumo)' + #13#10 +
                                    'where ap.sContrato=a.sContrato and ar.sNumfolio=a.iFolioRequisicion and app.sidinsumo=i.sIdInsumo),0) as pendiente ' +

      ' from anexo_prequisicion a  ' +
...
begin
  ...
  begin
    lblPartida.Caption := 'ID Material';
    dbPartidas.Visible := false;
    Grid_InsumosPendiente.Visible:=True;
  end
  else
  begin
    lblPartida.Caption := 'ID Material';
    dbPartidas.Visible := False;
    Grid_InsumosPendiente.Visible:=False;
  end;
  ...
  begin
    ...
    insumos.SQL.Add('select a.iFolioRequisicion as Requisicion, a.dCantidad as dCantidad, i.*, SubStr(i.mDescripcion, 1, 255) as sDescripcion, a.iItem, '+
      ...
      ' inner join almacenes alm on (alm.lPrincipal = "Si") '+
      ' inner join insumos i on (i.sIdAlmacen = alm.sIdAlmacen and a.sIdInsumo = i.sIdInsumo ) ' +
      ' where a.sContrato =:Contrato and FIND_IN_SET(a.iFolioRequisicion,:Folio)  and a.sEstado = "PENDIENTE" ');
    insumos.ParamByName('Contrato').AsString := global_contrato;
    insumos.ParamByName('Folio').AsString    := anexo_ocompras.FieldValues['sFolioRequisicion'];
   // insumos.ParamByName('Partida').AsString  := dbPartidas.Text;
    insumos.Open;
  ...
  begin
    ...
    insumos.SQL.Add('INNER JOIN almacenes AS b ON (a.sIdAlmacen = b.sIdAlmacen) ');
    insumos.SQL.Add('WHERE (:contrato=-1 or (:contrato<>-1 and a.sContrato = :contrato)) ');
    insumos.SQL.Add('and (:principal=-1 or (:principal<>-1 and b.lPrincipal=:principal))');
    If Connection.configuracion.fieldValues['sAlmcon'] = 'CONTRATOS' Then
    begin
...
begin
  Col_PrecioUnit.Options.Editing:=false;
  Col_Descuento.Options.Editing:=false;
  col_aplicaIva.Options.Editing:=false;
  frmBarra1.btnCancelClick(sender);
end;
  ...
  begin
   ...
   // tdCantidad.ReadOnly := False;
    ...
    {  Insertar1.Enabled := False;
      ...
      Grid_Insumos.Enabled:=False;
      Crear_Form(PanelInsumos, 'Catalogo de Materiales',430, 1010, []);    }
      Col_PrecioUnit.Options.Editing:=True;
      Col_Descuento.Options.Editing:=True;
      col_aplicaIva.Options.Editing:=True;
      frmBarra1.btnEditClick(Sender);
...
procedure TfrmPedidos.edtIsrEnter(Sender: TObject);
begin
 edtIsr.Color :=   Global_Color_Entrada ;
end;

procedure TfrmPedidos.edtIsrExit(Sender: TObject);
begin
   edtIsr.Color :=  Global_Color_Salida ;
end;

procedure TfrmPedidos.edtIsrIvaEnter(Sender: TObject);
begin
  edtIsrIva.Color := global_color_entrada ;
end;

procedure TfrmPedidos.edtIsrIvaExit(Sender: TObject);
begin
  edtIsrIva.Color := global_color_salida ;
end;

procedure TfrmPedidos.edtIsrIvaKeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
         tsCondiciones.SetFocus ;
end;

procedure TfrmPedidos.edtIsrKeyPress(Sender: TObject; var Key: Char);
begin
 if key=#13 then
...
procedure TfrmPedidos.btnPostClick(Sender: TObject);
begin
  if anexo_pocompras.State=dsEdit then
 ...
 begin
    if anexo_ocompras.RecordCount > 0 then
     begin
        ...
        tDescuentoGral.Value   := anexo_ocompras.FieldByName('dDescuento').AsFloat;
        edtIsr.Value           := anexo_ocompras.FieldByName('dIsr').AsFloat;
        edtIsrIva.Value        := anexo_ocompras.FieldByName('dIsrIva').AsFloat;
        tsTipoCambio.Value     := anexo_ocompras.FieldByName('dCambio').AsFloat;
