...
uses
  ...
  JvDBControls, dxCore, cxDateUtils, CheckLst;
...
type
  //Tfrm_Companias = class(TForm)
    ...
    pnlInformacionContactos: TPanel;
...
begin
  ...
  begin
    ...
    frmordenes.tsCliente.KeyValue:=zQCompanias.FieldValues['sIdCompania'];
    global_frmActivo := '';
  end;
end;
