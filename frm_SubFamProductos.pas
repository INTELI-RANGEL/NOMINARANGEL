...
type
  TfrmSubFamProductos = class(TForm)
    ...
    qryFamiliassIdFamilia: TWideStringField;
    qryFamiliassDescripcion: TWideStringField;
    qrysubFamiliasiIdSubfamilia: TIntegerField;
    qrysubFamiliassDescripcion: TWideStringField;
    qrysubFamiliassIdFamilia: TWideStringField;
    qrysubFamiliasfamilia: TWideStringField;
