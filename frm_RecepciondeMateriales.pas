...
type
  TfrmRecepcionDeMateriales = class(TForm)
    ...
    consumiblessDescripcion: TWideStringField;
    consumiblessIdInsumo: TWideStringField;
    consumiblesmDescripcion: TMemoField;
    consumiblesdCantidad: TFloatField;
    consumiblessMedida: TWideStringField;
    ...
    zq_recepciondematerialessContrato: TWideStringField;
    zq_recepciondematerialessTipoMovimiento: TWideStringField;
    zq_recepciondematerialesdFechaRecepcion: TDateField;
    zq_recepciondematerialessIdAlmacen: TWideStringField;
    zq_recepciondematerialesmNotas: TMemoField;
    zq_recepciondematerialessFolio: TWideStringField;
    ...
    zq_detallesderecepcionsIdInsumo: TWideStringField;
    zq_detallesderecepciondCantidad: TFloatField;
    ZQuery1: TZQuery;
    DataSource1: TDataSource;
    zq_detallesderecepcionsDescInsumo: TWideStringField;
    zq_detallesderecepcionsMedida: TWideStringField;
    zq_recepciondematerialessStatus: TWideStringField;
    zq_recepciondematerialesQuienValida: TWideStringField;
    frx_Recepciondemateriales: TfrxDBDataset;
    frxDBDataset2: TfrxDBDataset;
    frxDBDataset3: TfrxDBDataset;
    Frx_DetallesDeRecepcion: TfrxDBDataset;
    frxDBDataset5: TfrxDBDataset;
    zq_recepciondematerialessNombreAlmacen: TWideStringField;
...
begin
    ...
    begin
      ...
      ZQuery1.Params.ParamByName('sContrato').AsInteger:=-1;
    end;
    ZQuery1.Open;
    ...
    begin
      ...
      begin
        //insumos.ParamByName('Principal').AsString:='Si';
        // insumos.ParamByName('Contrato').AsInteger:=-1;
        zq_insumos.Params.ParamByName('sContrato').AsInteger:=-1;
      end;
...
procedure TfrmRecepcionDeMateriales.PgControlChanging(Sender: TObject;
  var AllowChange: Boolean);
begin
  AllowChange:=true;
  if zq_recepciondemateriales.State in [dsInsert,dsEdit] then
    AllowChange:=False;
end;
