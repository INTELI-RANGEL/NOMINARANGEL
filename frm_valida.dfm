object frmValida: TfrmValida
  ...
  object OrdenCompra: TZReadOnlyQuery
    Connection = connection.zConnection
    SQL.Strings = (
      'Select a.iFolioPedido,a.sOrdenCompra,a.sNumeroOrden,a.dIdFecha,'
      'Cast(IFNULL(Sum(pp.dCantidad * (pp.dCosto - pp.dDescuento)),0) '
      ' as  DECIMAL(20,2)) as dMontoMN,'
      'p.sRazonSocial, a.dFechaEntrega, a.sElaboro,'
      ' a.sReviso1,a.sStatus'
      ' from anexo_pedidos a '
      '  Inner Join proveedores p On ( p.sIdProveedor=a.sIdProveedor)'
      ' Inner join '
      '  anexo_ppedido as pp'
      
        '  on(pp.iFolioPedido = a.iFolioPedido and pp.sContrato =a.sContr' +
        'ato)'
      '  Where a.sContrato =:Contrato'
      '  and a.sStatus <> '#39'AUTORIZADO'#39
      '  Group By a.iFolioPedido '
      '  order by a.sOrdenCompra,a.iFolioPedido, a.dFechaEntrega')
    Params = <
      item
        DataType = ftUnknown
        Name = 'Contrato'
