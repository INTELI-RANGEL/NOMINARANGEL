...
type          
  TfrmIsometricos = class(TForm)
    ...
    procedure btnClasificacionClick(Sender: TObject);
...
implementation
uses
    frm_estimainstalado, frm_ordenes, frm_Isometricos_Grupo, frm_plataformas;
...
begin
  ...
  begin
    try
      ...
      Isometricos.FieldByName('sIdGrupo').AsString:= tsIdGrupo.KeyValue;
      Isometricos.FieldByName('sIdPlataforma').AsString:= tsIdPlataforma.KeyValue;
      Isometricos.Post ;
...
procedure TfrmIsometricos.btnClasificacionClick(Sender: TObject);
begin
    global_frmActivo := 'frm_Isometricos';
    Application.CreateForm(TfrmIsometricosGrupos, frmIsometricosGrupos);
    frmIsometricosGrupos.show;
end;

procedure TfrmIsometricos.btnPlataformasClick(Sender: TObject);
begin
    global_frmActivo := 'frm_Isometricos';
