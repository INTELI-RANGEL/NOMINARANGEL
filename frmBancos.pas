...
type
  ...
  frmBarra1: TfrmBarra;
    ...
    intgrfldbancosidbanco: TIntegerField;
    cbancosnombre: TStringField;
    cbancossucursal: TStringField;
    intgrfldbancosnumsucursal: TIntegerField;
    cbancostelefono: TStringField;
    cbancoscodigo: TStringField;
    cbancosactivo: TStringField;
    intgrfldIdBancoCFDI: TIntegerField;
    bancosImagen: TBlobField;
    intgrfldCodigoSAT: TIntegerField;
    grid_bancos: TcxGrid;
...
begin
  ...
  bancos.FieldValues['iCodigoSAT'] := 0 ;
  ...
  If bancos.RecordCount  > 0 then
    ...
    begin
      try
        ...
        connection.zcommand.SQL.Text := 'Update con_bancosnomina Set activo="No" Where idBanco =:IdBanco' ;
...
begin
    try
      ...
      begin
          ...
          frm_Empleados.tdBanco.KeyValue := bancos.FieldByName('idBanco').AsString;          Close;      end;    Except
    end;end;
