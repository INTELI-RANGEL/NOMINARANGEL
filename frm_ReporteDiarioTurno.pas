...
uses frm_inteligent, frm_bitacoraxalcance, frm_bitacoradepartamental_2, frm_entradaanex,
  ...
  frm_ordenesctrlobra, frm_turnos;
...
procedure TfrmDiarioTurno.btn8Click(Sender: TObject);
begin
  if not MostrarVentana('frmTurnos') Then
   begin
...
procedure TfrmDiarioTurno.BitBtn1Click(Sender: TObject);
begin
