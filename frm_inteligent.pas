...
uses
  ...
  ImgList, StdCtrls, RXClock, StdActns, PSAPI, StrUtils, ShellApi, Sockets,
  IdBaseComponent, IdComponent, IdTCPConnection, IdTCPClient, IdTime,
  IdTCPServer, IdUDPBase, IdUDPClient, IdEcho, Mask, utilerias, StoHtmlHelp,
  rxSpeedbar, frxpngimage, ToolWin, unt_ventas, UnitExcepciones,
  frm_SintesisGerencial, frm_herramientas, frm_copiacontratos, JvBackgrounds,
  Buttons, frm_catalogoerrores, iniFiles, ZConnection, unitmanejofondo,
  masutilerias, RxLookup, DBCtrls, Grids, DBGrids, rxToolEdit, rxCurrEdit,
  RXDBCtrl, JvComponentBase, JvAppEvent, CalcEvent, AppEvnts,frm_sincinformes,
  ...
  JvBrowseFolder, dxSkinMetropolis, dxSkinMetropolisDark, UDosCapas,
  dxSkinOffice2013DarkGray, dxSkinOffice2013LightGray, DateUtils,
  dxBarBuiltInMenu, dxRibbonCustomizationForm, FormAutoScaler, IdIOHandler,
  IdIOHandlerSocket, IdIOHandlerStack, IdSSL, IdSSLOpenSSL, dxGDIPlusClasses,
  URegistro, UInteliDialog;
...
type
  ...
  Cerrar_Todo: TdxBarButton;
    ...
    BlBtnResguardo: TdxBarLargeButton;
    BlBtnMail: TdxBarLargeButton;
    BlBtnEstatus: TdxBarLargeButton;
  ...
  procedure FormContextPopup(Sender: TObject; MousePos: TPoint;
    ...
    procedure dxButtonRequisicionesClick(Sender: TObject);
    procedure dxBarButton24Click(Sender: TObject);
    procedure dxBarLargeButton10Click(Sender: TObject);
    procedure dxblGiClick(Sender: TObject);
    procedure BlBtnResguardoClick(Sender: TObject);
    procedure BlBtnMailClick(Sender: TObject);
    procedure BlBtnEstatusClick(Sender: TObject);
private
...
public
  ...
  procedure llamarnombreprograma( Sender  : TObject) ;
...
uses frm_contratos, frm_deptos, frm_usuarios,
  ...
  frm_plataformas, frm_Cuentas, frm_Pernoctan, frm_ordenes, frm_actividades,
  frm_tiposdeMovimiento, frm_acceso, frm_acerca, frm_proveedores, frm_TipoMovto,
  frm_Almacenes, frm_tramitedepermisos, frm_valida, frm_registrodequejas,
  frm_abrereporte, frm_paquetesdeequipo, frm_paquetesdepersonal,
  frm_ConsultadeActividades, frm_CalculoAvancesxPartida,
  frm_ConsultaxDescripcion, frm_ActividadesAnexo, frm_diasfestivos,
  frm_platicas, frm_turnos, frm_ReporteDiarioTurno, frm_compara2,
  frm_comparativo, frm_ConsultadeActividades2, frm_BusquedadeNotas,
  frm_Reprogramacion, frm_recursosxanexo, frm_Proyeccion, frm_SqlManager,
  frm_importaciondedatos, frm_factordecosto, frm_AvancesFinancieros,
  frm_SqlImportar, frm_SqlExportar, frm_residencias, frm_programas,
  frm_GruposUsuarios, frm_gruposxprograma, frm_personalprogramado,
  frm_personalconsolidado, frm_contratosxusuario, frm_AjustaAnexo,
  frm_retecionesypenas, frm_PendientesNew, frm_ImportarDiarios,
  frm_comentariosxanexo, frm_ControlDirecto, frm_CalculoAvancesPaquetes,
  frm_ValidaEstimacion, frm_OrdendeCambio, frm_ConsultadeActividades3,
  frm_ConsultadeActividades4, frm_ExportaGeneral, frm_Kardex, frm_setup,
  frm_jornadasdiarias, frm_cambiapassword, frm_ReportePeriodo,
  frmReporteDiarioGerencial, frm_polizas, frm_FichaTecnica,
  frm_ConsultadeActividades5, frm_firmantes, frm_ActividadesAnexo2,
  frm_generado, frm_estimaciones, frm_actividadesxgrupo, frm_EstimaInstalado,
  frm_compara, frm_tipsdia, frm_warningdia, frm_AvisosAlertas, frm_activos,
  frm_seleccion2, frm_trinomios, frm_ProcRegAvFisico, frm_isometricos_grupo,
  frm_isometricos, frm_DistribucionPrograma, frm_admonCatalogos,
  frm_EstimaProveedor, frm_AjustaOrden, frm_SubContratos, frm_Pedidos,
  frm_ordenesPerf, frm_EqPozos, frm_Consumibles, frm_RequisicionPerf,
  frm_detalledeinstalacion, frm_Proyeccion2, frm_contratosxordenes,
  frm_AdmonyTiempos, frm_tripulacion, frm_tripulacion_diaria,
  frm_ReporteDiario_Barco, frm_partidasxisometrico, frm_Fases,
  frm_ordenesGral, FrmMovtoPersonalxoficio, frm_Gantt2, frm_GruposPersonal,
  frm_Graficador, frm_IntelChart, frm_grupofamilias, frm_basicos,
  frm_EntradaAlmacen, frm_SalidaAlmacen, frm_EstimacionGeneral,
  frm_ValidaEstimacionGral, frm_AperturaEstimacionGral,
  frm_Recursos_movimientos, frm_Recursos_pernocta, frm_AdministrarBd,
  frm_Recursos_personal, frm_Recursos_equipo, frm_cancelacion,
  ...
  frm_RecepciondeMateriales,  frm_DevolucionEquipoSeguridad,
  frm_InsumosxPersonal, frmNomina_NuevoPeriodo,  frm_ReportesAlmacen2,
  frm_HistorialMaterialxEmpleado, frm_ReporteSalidasAlmacen,
  ...
  frm_detallesubfamilias, frm_SubFamProductos, principal,
  frm_AlmacenesporUsuario, frm_AlmacenesporContrato, frmNomina_Pruebas,
  frm_ComponentXFamilia, frm_MarcasxSubFam, frmConfiguracion,
  frm_ZonasGeograficas, frmNomina_AbrirNomina, frmNomina_CapturaEgresos,
  frm_ListadeAsistencia, frm_ImprimeContratos, frm_ConfiguracionRH,
  frm_ModuloTraspaso, frm_NuevoIdioma, frm_DetalleGastosXEmpleados,
  frm_EquipoSeguridad, frm_ConfiguracionNomina, frm_AsignaciondeEquipoSeg,
  frm_catalogoestatusempleados, frm_catalogoestatusdiarioempleados,
  frm_catalogolocalidad_academico, Frm_ImportacionDatosRH,
  frm_catalogoestatusequipo, frm_catalogoentidadeseducativas,
  frm_catalogoprofesiones, frm_nivelorganizacion, frm_nuc_organizacion,
  frm_bancos, frm_TiposClientes, frmReportesIngresoscias,
  frm_RequisiondePersonal, Frm_CatalogoDePostulante, frm_repositorio,
  frm_FacturaElectronica, frm_FacturaElectronica_Lista, frm_CatDoctos,
  frmEmpleadosPorNomina, Func_Genericas,UManagerDbUser, frm_PrecioDivisas,
  frmReportesFacturas, frm_CatalogoVendedores, frm_configuracionVta,
  frm_catactualizaciones, frm_FormasPago, frm_vtacotizaciones, frm_vtaTimeLine,
  frm_firmasdigitales, frmDepositosciasTraspasos, frm_vtaTCotizaciones,
  frmOtrosGastos, frmGerencial, frmNotificaciones, frmCatalogoDeCargoA,
  frmTipoVisita, frmConsultadeGastos_Empresa, UTFrmIniciacionSaldo,
  UTFrmDevolucionEmpProv, frm_Medidas, frmDoctosXcategoria,
  frm_catalogohorariolabores, frm_catalogoperiodospago,
  frm_catalogonacionalidades, frm_catalogodiasdescanso, frmtipopersonal,
  frm_CatalgoCuentas, UTFrmEvaluarEmpleados, UTFrmGuardias, frm_ordenesctrlobra,
  frm_TipoInsumo, frm_SetupAlm, frm_ActividadesAnexoPU, UTFrmProgramaDeSalud,
  UTFrmCatalogoCargos, frm_Indirectos,frm_aclaraciones, frmDepsincuentas,
  frm_AsignarFactura, utfrmdepartamentos, UtfrmCatalogoSalarios,
  frm_anexosCotemar, frm_catalogomodulos, frm_Modulosxusuario,
  frm_ReporteErrores, frmBancos, frm_CambioContrato, frm_SetupPU,
  UfrmRequisicionesGlobales, frm_indirecto_grupo, Frm_Resguardo, Frm_SendMail,
  Frm_EstatusOrdenCompra;
...
begin
  ...
  //  //// TEMRINA LECTURA DE LA IMAGEN..
   ...
   // status.Panels.Items[5].Text  :=   global_db;
    ...
    Connection.ConfiguracionRecHum.Params.ParamByName('Contrato').AsString := global_contrato;
    ...
    MostrarVentana:=MostrarFormChild;
  except
...
procedure TfrmInteligent.dxBarButton24Click(Sender: TObject);
begin
   if not MostrarFormChild('frmIndirectosGrupo') Then
  begin
    Application.CreateForm(TfrmIndirectoGrupo, frmIndirectoGrupo);
    frmIndirectoGrupo.show;
  end;
end;
...
procedure TfrmInteligent.dxblGiClick(Sender: TObject);
begin
...
procedure TfrmInteligent.dxButtonRequisicionesClick(Sender: TObject);
begin
  llamarnombreprograma(sender);
  Application.CreateForm(TFrmRequisicionesGlobales, FrmRequisicionesGlobales);
  FrmRequisicionesGlobales.showmodal;
end;
...
procedure TfrmInteligent.BlBtnEstatusClick(Sender: TObject);
begin
  llamarnombreprograma(sender);
  if not MostrarFormChild('FrmEstatusOrdenCompra') then
  begin
    Application.CreateForm(TFrmEstatusOrdenCompra,FrmEstatusOrdenCompra);
    FrmEstatusOrdenCompra.show;
  end;
end;

procedure TfrmInteligent.BlBtnMailClick(Sender: TObject);
begin
...
procedure TfrmInteligent.BlBtnResguardoClick(Sender: TObject);
begin
  llamarnombreprograma(sender);
  Application.CreateForm(TFrmResguardo,FrmResguardo);
  FrmResguardo.Show;
end;
...
begin
  ...
  begin
    ...
    // Requisiciones por Validar
    if QryNot.FieldByName('sConcepto').AsString='REQUISICIONES POR VALIDAR' then
    begin
      QryCptos.SQL.Clear;
      QryCptos.SQL.Add('Select ar.sNumFolio from anexo_requisicion ar inner join usuarios u on (u.sIdUsuario=:Usuario) where u.lVerificaReq="Si" '+
                      'and ar.sContrato =:Contrato and ar.sStatus = "PENDIENTE" order by ar.dIdFecha');
    ...
    begin
      ...
      QryCptos.SQL.Add('Select ar.sNumFolio from anexo_requisicion ar inner join usuarios u on (u.sIdUsuario=:Usuario) where u.lAutorizaRequisiciones="Si" '+
                      'and ar.sContrato =:Contrato and ar.sStatus = "VALIDADO" order by ar.dIdFecha');
      QryCptos.ParamByName('Contrato').AsString:=global_contrato;
      QryCptos.ParamByName('Usuario').AsString:=global_usuario;
      QryCptos.Open;
    ...
    // Ord. de Compra por Validar
    if QryNot.FieldByName('sConcepto').AsString='ORD. DE COMPRA POR VALIDAR' then
    begin
      QryCptos.SQL.Clear;
      QryCptos.SQL.Add('Select ap.sOrdenCompra from anexo_pedidos ap inner join usuarios u on (u.sIdUsuario=:Usuario) where u.lVerificaReq="Si" '+
                      'and ap.sContrato =:Contrato and ap.sStatus = "PENDIENTE" order by ap.dFechaEntrega');
      QryCptos.ParamByName('Contrato').AsString:=global_contrato;
      QryCptos.ParamByName('Usuario').AsString:=global_usuario;
      QryCptos.Open;
    ...
    begin
      ...
      QryCptos.SQL.Add('Select ap.sOrdenCompra from anexo_pedidos ap inner join usuarios u on (u.sIdUsuario=:Usuario) where u.lAutorizaRequisiciones="Si" '+
                      'and ap.sContrato =:Contrato and ap.sStatus = "VALIDADO" order by ap.dFechaEntrega');
      QryCptos.ParamByName('Contrato').AsString:=global_contrato;
      QryCptos.ParamByName('Usuario').AsString:=global_usuario;
      QryCptos.Open;
...
procedure TfrmInteligent.llamarnombreprograma(Sender : TObject);
begin
stMenu := '';
  if sender is TdxBarLargeButton then
      stMenu := (sender as TdxBarLargeButton).Name;

  if sender is TMenuItem then
    stMenu := (sender as TMenuItem).Name;

  if sender is TMenuItem then
    stMenu := (sender as TdxBarButton).Name;
