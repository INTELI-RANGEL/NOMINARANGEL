...
uses frm_EstimacionAlbum, frm_admonCatalogos;
...
procedure TfrmEstimaciones.FormActivate(Sender: TObject);
begin
  if TiposdeEstimacion.Active then
    TiposdeEstimacion.Refresh;
end;
...
procedure TfrmEstimaciones.btn1Click(Sender: TObject);
begin
  HojaActiva:='TabTipEstimacion';
