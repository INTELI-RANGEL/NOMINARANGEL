object frmAbreReporte: TfrmAbreReporte
  Left = 369
  Top = 158
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 
    'Abrir Reportes Diarios/Generadores/Estimaciones/Requisiciones/Or' +
    'denes Compra'
  ClientHeight = 348
  ClientWidth = 902
  Color = 14145495
  ...
  object pgValidacion: TPageControl
    ...
    object TabRequisicion: TTabSheet
      ...
      object Grid_requisicion: TRxDBGrid
        ...
        TitleFont.Name = 'Arial'
        TitleFont.Style = [fsBold]
        OnMouseMove = Grid_requisicionMouseMove
        OnMouseUp = Grid_requisicionMouseUp
        OnTitleClick = Grid_requisicionTitleClick
        MultiSelect = True
    ...
    object TabOrdenCompra: TTabSheet
      ...
      object Grid_OrdenCompra: TRxDBGrid
        ...
        TitleFont.Name = 'Arial'
        TitleFont.Style = [fsBold]
        OnMouseMove = Grid_OrdenCompraMouseMove
        OnMouseUp = Grid_OrdenCompraMouseUp
        OnTitleClick = Grid_OrdenCompraTitleClick
        MultiSelect = True
    ...
    object tabRecepMateriales: TTabSheet
      ...
      object dbgRecepcion: TRxDBGrid
        ...
        Align = alClient
        Color = 15138559
        DataSource = dsRecepcionMateriales
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -9
        Font.Name = 'Arial'
        ...
        TitleFont.Style = [fsBold]
        MultiSelect = True
        OnGetCellParams = dbgRecepcionGetCellParams
        Columns = <
          item
            Expanded = False
            FieldName = 'sFolio'
  ...
  object SecretPanel1: TSecretPanel
    ...
    object BtnValida: TAdvGlowButton
      ...
      Width = 125
      Height = 46
      Caption = '&Valida Apertura Reportes Diarios'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -12
      Font.Name = 'Arial'
    ...
    object btnAutoriza: TAdvGlowButton
      ...
      Width = 125
      Height = 47
      Caption = '&Autoriza Apertura Reportes Diarios'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -12
      Font.Name = 'Arial'
  ...
  object Estimaciones: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'And lStatus <> "Pendiente" Order By iConsecutivo')
    Params = <
      item
        DataType = ftUnknown
        Name = 'contrato'
  ...
  object EstimacionPeriodo: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'o Where sContrato = :Contrato And lEstimado = "Si" Order By iNum' +
        'eroEstimacion')
    Params = <
      item
        DataType = ftUnknown
  ...
  object qryRecepcionMateriales: TZQuery
    Connection = connection.zConnection
    SQL.Strings = (
      'SELECT * '
    ...
    object qryRecepcionMaterialesiId: TIntegerField
      FieldName = 'iId'
    end
    object qryRecepcionMaterialessContrato: TStringField
      FieldName = 'sContrato'
      Size = 50
    end
    object qryRecepcionMaterialessFolio: TStringField
      FieldName = 'sFolio'
      Size = 50
    end
    object qryRecepcionMaterialessTipoMovimiento: TStringField
      FieldName = 'sTipoMovimiento'
      Size = 100
    end
    object qryRecepcionMaterialesdFechaRecepcion: TDateField
      FieldName = 'dFechaRecepcion'
    end
    object qryRecepcionMaterialessIdAlmacen: TStringField
      FieldName = 'sIdAlmacen'
      Size = 100
    end
    object qryRecepcionMaterialesmNotas: TMemoField
      FieldName = 'mNotas'
      BlobType = ftMemo
    end
    object qryRecepcionMaterialessStatus: TStringField
      FieldName = 'sStatus'
      Size = 50
    end
    object qryRecepcionMaterialesQuienValida: TStringField
      FieldName = 'QuienValida'
      Size = 50
    end
  end
  object dsRecepcionMateriales: TDataSource
    DataSet = qryRecepcionMateriales
    Left = 608
    Top = 232
  end
  object QrySalida: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'and s.sEstatus <> '#39'PENDIENTE'#39
