...
//continuainserccion de datos
  ...
  Try
     sId :=  GruposIsometrico.FieldByName('sIdGrupo').AsString;
   ...
   Try
      frmIsometricos.gruposisometrico.Refresh;
      frmIsometricos.tsIdGrupo.KeyValue := sId;
      frmIsometricos.tsIdGrupo.SetFocus;
    Except
    end;
