...
begin
  ...
  begin
    frxAnexoDMA.LoadFromFile(Global_Files + global_miReporte+ '_ALMDmoMateriales.fr3');
    if not FileExists(global_files + global_miReporte + '_ALMDmoMateriales.fr3') then
     showmessage('El archivo de reporte '+global_Mireporte+'_ALMDmoMateriales.fr3 no existe, notifique al administrador del sistema');
