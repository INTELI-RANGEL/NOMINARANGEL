...
begin
  ...
  begin
    ...
    Try
      ...
      // Cargar aquí los valores del rango
...
//              if CompareText(Cadena, '{365} then
      ...
      BEGIN
        try
          try
            ...
            //*Llenar en los valores de la nómina los valores de la jornada diaria que un trabajador deberia*/
      ...
      BEGIN
        try
          try
            ...
            //*Llenar en los valores de la nómina los valores de los minutos nos tranajados por dia de semana*/
            cdMinutosNt.First;
      ...
      begin
        ...
        begin
          ...
          xSMDF := Valores.Elemento('EMPLEADO.SalMinDF').AsFloat;
          xSMGZ := Valores.Elemento('EMPLEADO.SalMinGenZona').AsFloat;
          xDiasIMSS := Valores.Elemento('EMPLEADO.DIASTIMSS').AsFloat;
          xInasIMSS := Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsFloat;
          ...
          begin
            ...
            begin
              Aplicar := (xSMDF * (xDiasIMSS - xInasIMSS));
              //Aplicar := (Valores.Elemento('EMPLEADO.SalMinDF').AsFloat * (Valores.Elemento('EMPLEADO.DIASTIMSS').AsFloat - Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsFloat));
              DesgloseImss := DesgloseImss + '\n Aplica sobre [SMGVDF] SalMinDF:' + Valores.Elemento('EMPLEADO.SalMinDF').AsString + ' * DíasTImss: ' + Valores.Elemento('EMPLEADO.DIASTIMSS').AsString + ' - Inasistencias: ' + Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsString + ' = ' + FloatToStr(Aplicar);
            end;

            if Conjunto.FieldByName('AplicarSobre').AsString = 'SMGVZ' then
            begin
              Aplicar := (xSMGZ * (xDiasIMSS - xInasIMSS));
              //Aplicar := (xSMGZ * (Valores.Elemento('EMPLEADO.DIASTIMSS').AsFloat - Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsFloat));
              DesgloseImss := DesgloseImss + #10#13 + 'Aplica sobre [SMGVDF] SalMinGenZona: ' + Valores.Elemento('EMPLEADO.SalMinGenZona').asString + ' * DIASTIMSS:' + Valores.Elemento('EMPLEADO.DIASTIMSS').AsString + ' - Inasistencias: ' + Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsString + ' = ' + FloatToStr(Aplicar);
            end;

            if Conjunto.FieldByName('AplicarSobre').AsString = 'SBC' then
            begin
              Aplicar := (Valores.Elemento('EMPLEADO.SalarioIntegrado').AsFloat * (Valores.Elemento('EMPLEADO.DIASTIMSS').AsFloat - Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsFloat));
              DesgloseImss := DesgloseImss + #10#13 + 'Aplica sobre [SBC] SalarioIntegrado: ' + Valores.Elemento('EMPLEADO.SalarioIntegrado').AsString + ' * DIASTIMSS:' + Valores.Elemento('EMPLEADO.DIASTIMSS').AsString + ' - Inasistencias:' + Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsString + ' = ' + FloatToStr(Aplicar);
            end;
          ...
          begin
            ...
            if Conjunto.FieldByName('AplicarSobre').AsString = 'SMGVDF' then
            Begin
              Aplicar := (Valores.Elemento('EMPLEADO.SalMinDF').AsFloat - (Valores.Elemento('EMPLEADO.SalMinDF').AsFloat * Conjunto.FieldByName('CuantoExento').AsInteger)) * (Valores.Elemento('EMPLEADO.DIASTIMSS').AsFloat - Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsFloat);
              DesgloseImss := DesgloseImss + #10#13 + 'Aplica sobre [SMGVDF]: (SalMinDF ' + Valores.Elemento('EMPLEADO.SalMinDF').AsString + ' - SalMinDF' + Valores.Elemento('EMPLEADO.SalMinDF').AsString + ' * CuantoExcento' +  Conjunto.FieldByName('CuantoExento').AsString +')) * (DIASTIMSS ' + Valores.Elemento('EMPLEADO.DIASTIMSS').AsString + ' - Inasistencias ' + Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsString +') = ' + FloatToStr(Aplicar);
            End;

            if Conjunto.FieldByName('AplicarSobre').AsString = 'SMGVZ' then
            begin
              Aplicar := (Valores.Elemento('EMPLEADO.SalMinGenZona').AsFloat - (Valores.Elemento('EMPLEADO.SalMinDF').AsFloat * Conjunto.FieldByName('CuantoExento').AsInteger)) * (Valores.Elemento('EMPLEADO.DIASTIMSS').AsFloat - Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsFloat);
            ...
            begin
              ...
              pDiasTIMSS := Valores.Elemento('EMPLEADO.DIASTIMSS').AsFloat;
              Aplicar := (pSalarioIntegrado - (pSalMinDF * Conjunto.FieldByName('CuantoExento').AsInteger)) * (pDiasTIMSS - Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsFloat);
              DesgloseImss := DesgloseImss + #10#13 + 'Aplica sobre [SBC]: (SDI ' + FloatToStr(pSalarioIntegrado) + ' - (SalMinDF ' + FloatToStr(pSalMinDF) + ' * CuantoExcento ' + Conjunto.FieldByName('CuantoExento').AsString + ')) * (DiasTIMSS ' + FloatToStr(pDiasTIMSS) + ' - Inasistencias ' + Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsString + ') = ' + FloatToStr(Aplicar);
            end;
          ...
          begin
            ...
            if Conjunto.FieldByName('AplicarSobre').AsString = 'SMGVDF' then
            begin
              Aplicar := (Valores.Elemento('EMPLEADO.SalMinDF').AsFloat * (Valores.Elemento('EMPLEADO.DIASTIMSS').AsFloat - Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsFloat)) - (Valores.Elemento('EMPLEADO.SalMinGenZona').AsFloat * Conjunto.FieldByName('CuantoExento').AsInteger);
              DesgloseImss := DesgloseImss + #10#13 + 'Aplica sobre [SMGVDF]: (SalMinDF ' + Valores.Elemento('EMPLEADO.SalMinDF').AsString + ' * DIASTIMSS ' + '( ' + Valores.Elemento('EMPLEADO.DIASTIMSS').AsString + ' - Inasistencias ' +Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsString + ')) - (SalMinGenZona: ' + Valores.Elemento('EMPLEADO.SalMinGenZona').AsString + ' * CuantoExcento ' + Conjunto.FieldByName('CuantoExento').AsString + ') = ' + FloatToStr(Aplicar);
            end;

            if Conjunto.FieldByName('AplicarSobre').AsString = 'SMGVZ' then
            begin
              Aplicar := (Valores.Elemento('EMPLEADO.SalMinGenZona').AsFloat * (Valores.Elemento('EMPLEADO.DIASTIMSS').AsFloat - Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsFloat)) - (Valores.Elemento('EMPLEADO.SalMinGenZona').AsFloat * Conjunto.FieldByName('CuantoExento').AsInteger);
            ...
            if Conjunto.FieldByName('AplicarSobre').AsString = 'SBC' then
            begin
              Aplicar := (Valores.Elemento('EMPLEADO.SalarioIntegrado').AsFloat * (Valores.Elemento('EMPLEADO.DIASTIMSS').AsFloat - Valores.Elemento('EMPLEADO.InasistenciasIMSS').AsFloat)) - (Valores.Elemento('EMPLEADO.SalMinGenZona').AsFloat * Conjunto.FieldByName('CuantoExento').AsInteger);
      ...
      Try
        ...
        begin
          ...
          if not CargarDatosFiltrados(cdPlantilla, 'idTipoNomina,IdMachoteTipoNomina', [DataSet.FieldByName('IdTipoNomina').AsInteger, LibroExcel]) then
            raise InteligentException.CreateByCode(6, ['Tipos Nómina', DataSet.FieldByName('IdTipoNomina').AsInteger, 'IdTipoNomina']);
        ...
        begin
          ...
          try
            ...
            CoordenadasXY := VarToStr(ExcelM.Range['A1'].value); // obtener valores de las coordenadas de la región a utilizar para descomponerlas
            ModoInsercion := VarToStr(ExcelM.Range['B1'].Value); //Valor del Modo inserción [0=Sustitución, 1=INSERCCION RENGLONES]
            ...
            //Obtener el ancho de las columnas para poder ajustar las copias a un tamano estándar
            for j := 1 to ColY do
        ...
        begin
          ...
          begin
            ...
            Valores.SetValue('EMPLEADO.SalMinDF', SMGVDF, 'SMGVDF,SMGVDF,Salario_Minimo_D.F.,SALARIO MINIMO GENERAL VIGENTE DEL D.F.,MEMORIA,Nil,No');    // Guardar en la memoria el valor del salario mínimo general vigente para el D.F.
            ...
            begin
              ...
              if TieneValor = false then  //Para que no me esté chingando a cada rato el mensaje
              begin
                try
    ...
    Try
      ...
      Try
        ...
        Try
          ...
          CargarDatosFiltrados(cdBuscar, 'IdOrganizacion,IdTipoNomina,IdDepartamento,Aplicacion,Anios', [IdOrganizacion, IdTipoNomina, IdDepartamento, FechaACadena(Now), Antiguedad]);
          cdBuscar.Open;
      ...
      begin
        if limite <> -1 then
          if AproxSalario < SalMinGenZona then
            raise InteligentWarning.CreateByCode(24, ['Debe agregar una cantidad mayor a $' + FloatToStr(Limite) + ' para poder proceder con el cálculo.' + #10 + #10 + 'Esto se debe a que el salario diario no puede ser menor a $' + FloatToStr(SalMinGenZona)+'.']);
