object FrmVacaciones: TFrmVacaciones
  Left = 0
  Top = 0
  Caption = 'Cat'#225'logo de Prestaciones (Vacaciones)'
  ClientHeight = 379
  ClientWidth = 714
  Color = clBtnFace
  ...
  object advsmthpnl1: TAdvSmoothPanel
    ...
    object advsmthpnl2: TAdvSmoothPanel
      Left = 87
      Top = 14
      Width = 625
      Height = 33
      ...
      TabOrder = 0
      Padding.Right = 6
      object cbTipoNomina1: TAdvComboBox
        Left = 0
        Top = 0
        Width = 619
        Height = 21
  ...
  object advfcpgr1: TAdvOfficePager
    ...
    Height = 271
    Align = alClient
    ActivePage = advfcpgPage_Aguinaldo
    ...
    object advfcpgPage_Aguinaldo: TAdvOfficePage
      ...
      object TabDiasVacaciones: TAdvTabSet
        Left = 2
        Top = 223
        Width = 708
        Height = 18
        ...
        TabOverlap = 0
        TabStyle = tsDotNet
        OnChanged = TabDiasVacacionesChanged
      end
      object pnl_DatosLinea: TPanel
        ...
        object EdtGrupoTabla: TDBAdvEdit
          Left = 96
          Top = 62
          Width = 209
          Height = 21
          LabelCaption = 'Grupo Tabla:'
          LabelFont.Charset = DEFAULT_CHARSET
          LabelFont.Color = clWindowText
          LabelFont.Height = -11
          LabelFont.Name = 'Tahoma'
          ...
          Visible = True
          Version = '2.9.0.0'
          DataField = 'GrupoTabla'
          DataSource = dsEdicion
        end
        object EdtFechaAplicacion: TAdvDBDateTimePicker
          Left = 96
          Top = 7
          Width = 98
          Height = 21
          Date = 41473.770347222220000000
          Format = 'yyyy-MM-dd'
          Time = 41473.770347222220000000
          DoubleBuffered = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          ...
          Ctl3D = True
          DateTime = 41473.770347222220000000
          Version = '1.1.0.1'
          LabelCaption = 'Fecha Aplicacion'
          LabelFont.Charset = DEFAULT_CHARSET
          LabelFont.Color = clWindowText
          LabelFont.Height = -11
          LabelFont.Name = 'Tahoma'
  ...
  object dsAguinaldo_Sel: TDataSource
    Left = 272
    Top = 176
  end
  object cdAguinaldo_Sel: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 136
    Top = 184
  ...
  object cdVacaciones: TClientDataSet
    Aggregates = <>
    Params = <>
    AfterOpen = cdVacacionesAfterOpen
    AfterRefresh = cdVacacionesAfterRefresh
    Left = 128
    Top = 248
  end
  object cdPrimaVacacional: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 48
    Top = 296
  end
  object dsPrimaVacacional: TDataSource
    Left = 48
    Top = 248
  end
  ...
  object cdAguinaldo: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 176
    Top = 72
  ...
  object CdVacacionesPeriodos: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 240
    Top = 336
  end
  object CdVacacionesUpt: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 544
    Top = 144
  ...
  object dsEdicion: TDataSource
    DataSet = CdVacacionesUpt
    Left = 256
    Top = 232
  end
  ...
  object frxReporteVacaciones: TfrxReport
    Version = '4.10.3'
    ...
    ReportOptions.LastChange = 42114.853672847230000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Cat'#225'logo de Dias de Vacaciones.')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 740.409927000000000000
        Condition = 'ReporteVacaciones."IdDiasVacaciones"'
      end
    end
  end
  object frxVacaciones: TfrxDBDataset
    UserName = 'ReporteVacaciones'
    CloseDataSource = False
    FieldAliases.Strings = (
      'IdDiasVacaciones=IdDiasVacaciones'
      'IdTiponomina=IdTiponomina'
      'GrupoTabla=GrupoTabla'
