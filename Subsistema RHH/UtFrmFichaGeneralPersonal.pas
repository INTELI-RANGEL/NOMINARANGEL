...
begin
  ...
  try
    ...
    on e:Exception do
      InteliDialog.ShowModal('Han ocurrido un error inesperado', 'Informe de lo siguiente al administrador del sistema:' + #10 + #10 + e.message, mtError, [mbOk], 0);
  end;
end;
...
begin
  ...
  begin
    ...
    ListaErrores.Add('> El campo ' + MensajeError + ' debe ser llenado correctamente antes de continuar');
...
begin
  try
    ...
    begin
      ...
      ListaErrores.Add('> El Número de Seguro Social debe estar conformado de 11 dígitos');
    ...
    begin
      ...
      ListaErrores.Add('> Debe seleccionar una organizacion para el empleado.');
      //raise InteligentWarning.CreateByCode(24, ['Debe seleccionar una organizacion para el empleado.']);
    end;

    if ListaErrores.Count > 0 then
    begin
      CadenaError := StringReplace(ListaErrores.CommaText, ',', #10, [rfReplaceAll]);

      raise InteligentWarning.CreateByCode(8, ['Ha ocurrido los siguientes errores:' + #10 + #10 + CadenaError]);
    end;
