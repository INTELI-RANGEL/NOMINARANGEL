object FrmExcepciones: TFrmExcepciones
  ...
  object RepoInasistencias: TfrxReport
    Version = '4.10.3'
    ...
    ReportOptions.CreateDate = 42651.287156180600000000
    ReportOptions.LastChange = 42651.305268634260000000
    ...
    Datasets = <
      item
        DataSet = fdsInasistencia
        DataSetName = 'dsInasistencia'
      end
      item
        DataSet = fdsPersonal
        DataSetName = 'fdsPersonal'
      end
      item
        DataSet = FrmCatalogoPersonalDEX.frxDBOrganizacion
    ...
    object Page1: TfrxReportPage
      ...
      object Header1: TfrxHeader
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBOrganizacion."nombreorganizacion"]')
          ParentFont = False
        end
      end
    end
  ...
  object fdsInasistencia: TfrxDBDataset
    UserName = 'dsInasistencia'
    CloseDataSource = False
    FieldAliases.Strings = (
  ...
  object fdsOrganizacion: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'Estado=Estado'
      'Pais=Pais'
      'idRiesgoCFDI=idRiesgoCFDI')
    DataSource = Form2.DsOrganizacion
    BCDToCurrency = False
    Left = 552
    Top = 208
  end
