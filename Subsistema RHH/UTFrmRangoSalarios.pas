          ...
          begin
            ...
            begin
              GenerarCalculoVirtual(Self,
                                    ...
                                    cdDepartamento.FieldByName('IdDepartamento').AsInteger,
...
begin
  ...
  Try
    ...
    if (cdDepartamento.ProviderName <> '') and (cdDepartamento.Active) and (cdDepartamento.FieldByName('IdOrganizacion').AsInteger <> cdOrganizacion.FieldByName('IdOrganizacion').AsInteger) then
    begin
      if Not CargarDatosFiltrados(cdDepartamento, 'IdOrganizacion', [cdOrganizacion.FieldByName('IdOrganizacion').AsInteger]) then
        raise InteligentException.CreateByCode(6, ['Departamentos', cdOrganizacion.FieldByName('IdOrganizacion').AsInteger, 'Id. Organizacion']);
...
begin
  ...
  EliminarConjunto([cdSalMinDF, cdRango, cdHistorial, cdMoneda, cdTipoNomina, cdDepartamento, cdGrupoSalario, cdSalarios, cdOrganizacion]);
