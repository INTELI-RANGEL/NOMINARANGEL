...
begin
  Try
        ...
        begin
          ...
          begin
            ...
            try
              ...
              begin
                CSD.Certificado := ExtractFilePath(Application.ExeName) + 'certs\aaa010101aaa_FIEL.cer';  //'certs\aad990814bp7_1210261233s.cer';
                CSD.Llave := ExtractFilePath(Application.ExeName) + 'certs\AAA010101AAA_FIEL.key';  //'certs\aad990814bp7_1210261233s.key';
                CSD.Clave := '12345678a';
                Empresa.RFC:= 'AAA010101AAA'; //rfc de prueba
              end
              else
              begin
    ...
    //*******REVISAR EL TIPO DE REGIMEN Y PREGUNTAR A PATRICIO
              ...
              try
                Empleado.ComplementoNomina.DiasPagados := StrToFloat(cdPersonalIncluido.FieldByName('DiasT').AsString); //El objeto calcula los días
              except
                Empleado.ComplementoNomina.DiasPagados := 0.0;
              end;
              CxProgressBarIndividual.Position := CxProgressBarIndividual.Position + 20;
            except
              on e: Exception do
