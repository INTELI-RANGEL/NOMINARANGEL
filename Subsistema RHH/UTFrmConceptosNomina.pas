...
type
  ...
  TFrmConceptosNomina = class(TForm)
    ...
    cxDbEdCveSat: TcxDBTextEdit;
    dxLayoutControl2Item9: TdxLayoutItem;
    cxDbEdTituloSat: TcxDBTextEdit;
...
//    CargarDatosFiltrados(cdConcepto, 'IdTipoNomina,Aplicacion', [Integer(cbbtiponomin.Items.Objects[cbbtiponomin.ItemIndex]), anio]);
    ...
    cdConcepto.Open;
    cxGridConceptos.DataController.Groups.FullExpand;
...
//        end;
        ...
        begin
          ...
          cdBuscar.FieldByName('CveSat').AsString := cxDbEdCveSat.Text;
          cdBuscar.FieldByName('TituloSat').AsString := cxDbEdTituloSat.Text;
...
begin
  try
    ...
    if ((cdBuscar.State = dsEdit) and (FormulaOriginal <> mCadena.Text)) or (cdBuscar.State = dsInsert) then
    begin
