...
uses
  ...
  NxCollection, sMaskEdit, sCustomComboEdit, sCurrEdit, JvExMask,
...
type
  TfrmCuadredePersonal = class(TForm)
    ...
    lbl2: TLabel;
    cmdTipoObra: TButton;
    tPersonal1: TJvCalcEdit;
    tPersonal2: TJvCalcEdit;
    rxPersonal_PU: TRxMemoryData;
    ds_tiposPersonal: TDataSource;
    zTiposPersonal: TZQuery;
    lbl4: TLabel;
    lbl3: TLabel;
    tPersonal3: TJvCalcEdit;
    tPersonal4: TJvCalcEdit;
    lbl6: TLabel;
    lbl5: TLabel;
    tPersonal5: TJvCalcEdit;
    tPersonal6: TJvCalcEdit;
    lbl7: TLabel;
    tPersonal7: TJvCalcEdit;
