...
begin
  ...
  try
    ...
    End ;
    frxReporte.LoadFromFile(global_files + global_miReporte + '_ALMKardexGral_PartidasInsumos.fr3');
  ...
  try
      ...
      Begin
          ...
          If Connection.qryBusca.RecordCount > 1 Then
              procCaratulaGenerador (0, global_contrato, Generado.FieldValues['iNumeroEstimacion'] , Generado.FieldValues['sNumeroOrden'] , Generado.FieldValues['sNumeroGenerador'] , global_convenio, frmConsultaActividad5, frxReporte.OnGetValue, True)
          Else
              procCaratulaGenerador (0, global_contrato, Generado.FieldValues['iNumeroEstimacion'] , Generado.FieldValues['sNumeroOrden'] , Generado.FieldValues['sNumeroGenerador'] , global_convenio, frmConsultaActividad5, frxReporte.OnGetValue, False)
      End
      Else
