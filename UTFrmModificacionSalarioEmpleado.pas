...
type
  TFrmModificacionSalarioEmpleado = class(TForm)
    ...
    tvSeleccionadosColumn2: TcxGridDBColumn;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        memSeleccionados.FieldByName('Salario').AsFloat := cdAnalisis.FieldByName('Salario').AsFloat;
        memSeleccionados.FieldByName('Integrado').AsFloat := cdAnalisis.FieldByName('SalarioIntegradoMod').AsFloat;
        memSeleccionados.FieldByName('NombreCompleto').AsString := cdAnalisis.FieldByName('NombreCompleto').AsString;
        memSeleccionados.FieldByName('Departamento').AsString := cdAnalisis.FieldByName('TituloDepartamento').AsString;
        memSeleccionados.FieldByName('Cargo').AsString := cdAnalisis.FieldByName('TituloCargo').AsString;
    ...
    GridAnalisis.FocusedView := tvSeleccionados;
  finally
