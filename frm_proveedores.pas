...
uses
  ...
  cxGridCustomView, cxGrid, ExportaExcel, dxBarBuiltInMenu, cxPC, cxButtons,
  masUtilerias, cxPCdxBarPopupMenu, FormAutoScaler, utilerias, frxClass,
  frxDBSet, UDosCapas;
type
  TfrmProveedores = class(TForm)
    ...
    ProveedoressIdProveedor: TWideStringField;
    ProveedoressRazon: TWideStringField;
    ProveedoressDomicilio: TWideStringField;
    ProveedoressCiudad: TWideStringField;
    ProveedoressEstado: TWideStringField;
    ProveedoressRfc: TWideStringField;
    ProveedoressTelefono: TWideStringField;
    ProveedoressCuenta: TWideStringField;
    ProveedoressSucursal: TWideStringField;
    ProveedoressBanco: TWideStringField;
    ProveedoresmComentarios: TMemoField;
    ProveedoressRepresentante: TWideStringField;
    ProveedoressVendedor: TWideStringField;
    ProveedoressEmail: TWideStringField;
    ProveedoressNombreCuenta: TWideStringField;
    ProveedoressClaveBan: TWideStringField;
    ProveedoressCp: TWideStringField;
    ProveedoressExt: TWideStringField;
    ProveedoressFax: TWideStringField;
    ProveedoresiId: TIntegerField;
    ProveedoressNombreCorto: TWideStringField;
    dsBancos: TDataSource;
    qryBancos: TZQuery;
    zq_contratos: TZQuery;
    strngfldProveedoressRazonSocial: TWideStringField;
...
uses
    ...
    Func_Genericas, frmBancos, UInteliDialog;
{$R *.dfm}
...
begin
  try
    ...
    //Abrir query de bancos de frmCatalogoDeCuentas
    ...
    //continuainserccion de datos
     try
        ...
        begin
         ...
         try
            frmConsumibles.Proveedores.Refresh;
            frmConsumibles.dbProveedores.KeyValue := IdProveedor;
            frmConsumibles.dbProveedores.SetFocus;
         Except
         end;
      ...
      begin
        begin
          ...
          begin
            ...
            try
              Proveedores.Delete ;
              if (global_frmActivo = 'frm_consumibles') then
              begin
                frmConsumibles.Proveedores.Refresh;
                frmConsumibles.dbProveedores.SetFocus;
              end;
...
procedure TfrmProveedores.btnPrinterClick(Sender: TObject);
begin
 (*Creada:12/09/2013 Creo:Jose Angel Soriano Gonzalez
Descripcion:Imprime la lista de los Proveedores *)
begin
  if not FileExists(global_files + global_miReporte + '_proveedores.fr3') then
    begin
       showmessage('El archivo de reporte '+global_Mireporte+'_proveedores.fr3 no existe, notifique al administrador del sistema');
       exit;
    end;
   If Proveedores.RecordCount > 0 Then   //RRT 12/09/2013: Valida que la tabla tenga datos
   begin                                                                  //RRT 12/09/2013: Si la tabla tiene datos
      frxProveedor.LoadFromFile(global_files + global_miReporte + '_proveedores.fr3') ;  //RRT 12/09/2013: Carga el reporte
      frxProveedor.ShowReport();                                          //RRT 12/09/2013: Muestra el reporte
   end;
end;
end;
