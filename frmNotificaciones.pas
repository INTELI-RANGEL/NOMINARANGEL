...
uses
  ...
  cxSpinEdit, cxTimeEdit, dxBarBuiltInMenu;
...
begin
  ...
  begin
    cbConceptoV.Properties.Items.Add('REQUISICIONES POR VALIDAR');
    cbConceptoV.Properties.Items.Add('REQUISICIONES POR AUTORIZAR');
    cbConceptoV.Properties.Items.Add('ORD. DE COMPRA POR VALIDAR');
