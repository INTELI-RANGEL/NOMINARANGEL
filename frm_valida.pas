...
uses
  ...
  cxCheckBox, FormAutoScaler, dxmdaset;
...
uses frm_seguridad, frm_bitacoraxalcance, frm_bitacoradepartamental_2,
  frm_ReporteDiarioTurno, frm_Pedidos, frm_RequisicionPerf, Frm_ExportPDF,
  Frm_SendMail, UFunctionsGHH;
...
begin
  ...
  connection.zCommand.Params.ParamByName('Orden').asString    := sParamOrden;
  ...
  qryBitacora.Params.ParamByName('contrato').asString := sParamContrato;
  qryBitacora.Params.ParamByName('convenio').asString := sParamConvenio;
  qryBitacora.Params.ParamByName('Orden').asString    := sParamOrden;
  qryBitacora.Params.ParamByName('fecha').asDate      := dParamFecha;
  qryBitacora.Params.ParamByName('Turno').asString    := sParamTurno;
  qryBitacora.Open;
  ...
  begin
    ...
    begin
      try
        ...
        connection.qryBusca.Params.ParamByName('Orden').asString     := sParamOrden;
        ...
        connection.zCommand.Params.ParamByName('CantidadAnterior').asFloat := dCantidadAnterior;
        connection.zCommand.Params.ParamByName('AvanceAnterior').asFloat   := dAvanceAnterior;
        connection.zCommand.Params.ParamByName('CantidadActual').asFloat   := qryBitacora.FieldValues['dCantidadActual'];
        connection.zCommand.Params.ParamByName('AvanceActual').asFloat := qryBitacora.FieldValues['dAvanceActual'];
        connection.zCommand.ExecSQL;
      except
  ...
  begin
    ...
    begin
      try
        ...
        connection.zCommand.Params.ParamByName('Avance').AsFloat    := QryBitacora.FieldValues['dAvanceReal'];
        connection.zCommand.ExecSQL;
      except
        MessageDlg('Ocurrio un error al actualizar el registro en la bitacora de actividades', mtWarning, [mbOk], 0);
      end;
...
begin
  ...
  qryBitacora.Params.ParamByName('contrato').AsString := global_contrato;
  qryBitacora.Params.ParamByName('Orden').AsString    := sParamOrden;
  qryBitacora.Params.ParamByName('fecha').asDate      := dParamFecha;
  qryBitacora.Params.ParamByName('Turno').AsString    := sParamTurno;
  qryBitacora.Open;
  ...
  begin
    ...
    begin
      try
        ...
        connection.qryBusca.Params.ParamByName('Wbs').AsString       := qryBitacora.FieldValues['sWbs'];
        connection.qryBusca.Params.ParamByName('Actividad').AsString := qryBitacora.FieldValues['sNumeroActividad'];
        connection.qryBusca.Params.ParamByName('Fase').AsInteger     := qryBitacora.FieldValues['iFase'];
        connection.qryBusca.Open;
        dCantidadAnterior := 0;
        dAvanceAnterior := 0;
        if connection.qryBusca.RecordCount > 0 then
        ...
        connection.zCommand.Params.ParamByName('CantidadAnterior').asFloat := dCantidadAnterior;
        connection.zCommand.Params.ParamByName('AvanceAnterior').asFloat   := dAvanceAnterior;
        connection.zCommand.Params.ParamByName('CantidadActual').asFloat   := qryBitacora.FieldValues['dCantidad'];
        connection.zCommand.Params.ParamByName('AvanceActual').asFloat     := qryBitacora.FieldValues['dAvance'];
        connection.zCommand.ExecSQL;
      except
        MessageDlg('Ocurrio un error al actualizar el registro en la bitacora de actividades', mtWarning, [mbOk], 0);
      end;
...
begin
  ...
  connection.qryBusca.Params.ParamByName('Contrato').asString := sParamContrato;
  connection.qryBusca.Params.ParamByName('Fecha').asDate      := dParamFecha;
  connection.qryBusca.Params.ParamByName('Orden').asString    := 'CONTRATO NO. ' + sParamContrato;
  Connection.qryBusca.Open;
  if Connection.qryBusca.RecordCount > 0 then
  begin
    ...
    connection.qryBusca.Params.ParamByName('Contrato').asString := sParamContrato;
    connection.qryBusca.Params.ParamByName('status').asString := connection.configuracion.FieldValues['cStatusProceso'];
    Connection.qryBusca.Open;
    while not Connection.qryBusca.Eof do
    begin
      ...
      Connection.qryBusca2.Params.ParamByName('Fecha').asDate      := dParamFecha;
      Connection.qryBusca2.Params.ParamByName('Orden').asString    := Connection.qryBusca.FieldValues['sNumeroOrden'];
      ...
      MaximoDiario.Params.ParamByName('Contrato').asString := sParamContrato;
      ...
      connection.zCommand.Params.ParamByName('Turno').asString     := sParamTurno;
      connection.zCommand.Params.ParamByName('Depto').asString     := global_depto;
      connection.zCommand.Params.ParamByName('Orden').asString     := Connection.qryBusca.FieldValues['sNumeroOrden'];
      connection.zCommand.Params.ParamByName('Tipo').asString      := 'AE';
      connection.zCommand.Params.ParamByName('Descripcion').asMemo := StringList.Text + StringListxOrden.Text;
      connection.zCommand.ExecSQL();
      Connection.qryBusca.Next;
    end;
  end
  ...
  begin
    ...
    begin
      ...
      connection.zCommand.Params.ParamByName('Orden').asString     := sParamOrden;
      connection.zCommand.Params.ParamByName('Tipo').asString      := 'AE';
      connection.zCommand.Params.ParamByName('Descripcion').AsMemo := StringList.Text;
      connection.zCommand.ExecSQL();
      Connection.qryBusca.Next
    end
  end;
...
begin
  try
        ...
        with Grid_OrdenCompra.DataSource.DataSet do
          ...
          begin
            ...
            begin
              ...
              connection.zCommand.ParamByName('Contrato').asString := global_contrato;
              connection.zCommand.ParamByName('Pedido').asInteger  := OrdenCompra.FieldValues['iFolioPedido'];
              connection.zCommand.ExecSQL;
        ...
        with Grid_RecepcionDeMateriales.DataSource.DataSet do
          ...
          begin
            ...
            begin
              ...
              connection.zCommand.ParamByName('Contrato').asString := global_contrato;
              connection.zCommand.ParamByName('sFolio').asString   := zq_recepciondemateriales.FieldValues['sFolio'];
              connection.zCommand.ExecSQL;
            end
            else
        ...
        with grid_salidas.DataSource.DataSet do
          ...
          begin
            ...
            begin
              ...
              connection.zCommand.ParamByName('Contrato').asString := global_contrato;
              connection.zCommand.ParamByName('Folio').AsInteger  := QrySalida.FieldValues['iFolioSalida'];
              connection.zCommand.ExecSQL;
            end
            else
        ...
        with Grid_reportes.DataSource.DataSet do
          ...
          begin
            ...
            begin
              ...
              connection.zCommand.Params.ParamByName('Contrato').asString := Global_Contrato;
              connection.zCommand.Params.ParamByName('convenio').asString := FieldValues['sIdConvenio'];
              connection.zCommand.Params.ParamByName('Orden').asString    := FieldValues['sNumeroOrden'];
              connection.zCommand.Params.ParamByName('Fecha').asDate      := FieldValues['dIdFecha'];
              connection.zCommand.ExecSQL;
              ...
              connection.zCommand.Params.ParamByName('Contrato').AsString := Global_Contrato;
              connection.zCommand.Params.ParamByName('convenio').AsString := FieldValues['sIdConvenio'];
              connection.zCommand.Params.ParamByName('Orden').AsString    := '';
              connection.zCommand.Params.ParamByName('Fecha').AsDate      := FieldValues['dIdFecha'];
              connection.zCommand.ExecSQL;
              ...
              connection.zCommand.Params.ParamByName('Contrato').asString    := Global_Contrato;
              connection.zCommand.Params.ParamByName('Orden').AsString       := FieldValues['sNumeroOrden'];
              connection.zCommand.Params.ParamByName('Fecha').AsString       := FieldValues['dIdFecha'];
              connection.zCommand.Params.ParamByName('Turno').AsString       := FieldValues['sIdTurno'];
              connection.zCommand.Params.ParamByName('Status').AsString      := 'Validado';
              connection.zCommand.Params.ParamByName('Valida').AsString      := global_valida;
              connection.zCommand.Params.ParamByName('ProgAntOrden').AsFloat := dProgramadoOrdenAnterior;
              connection.zCommand.Params.ParamByName('ProgActOrden').AsFloat := dProgramadoOrdenActual;
              connection.zCommand.Params.ParamByName('RealAntOrden').AsFloat := dRealOrdenAnterior;
              connection.zCommand.Params.ParamByName('RealActOrden').AsFloat := dRealOrdenActual;
              connection.zCommand.ExecSQL();
              ...
              connection.zCommand.Params.ParamByName('Contrato').asString        := Global_Contrato;
              connection.zCommand.Params.ParamByName('Fecha').asDate             := FieldValues['dIdFecha'];
              connection.zCommand.Params.ParamByName('ProgAntContrato').AsFloat  := dProgramadoGlobalAnterior;
              connection.zCommand.Params.ParamByName('ProgActContrato').AsFloat  := dProgramadoGlobalActual;
              connection.zCommand.Params.ParamByName('RealAntContrato').AsFloat  := dRealGlobalAnterior;
              connection.zCommand.Params.ParamByName('RealActContrato').AsFloat  := dRealGlobalActual;
              connection.zCommand.ExecSQL();
              ...
              connection.zCommand.Params.ParamByName('Descripcion').asString := 'Validación del Reporte Diario No. [' + FieldValues['sNumeroReporte'] + ']. VALIDA ' + global_valida;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            connection.zCommand.Params.ParamByName('Contrato').asString   := Global_Contrato;
            connection.zCommand.Params.ParamByName('Orden').asString      := FieldValues['sNumeroOrden'];
            connection.zCommand.Params.ParamByName('Estimacion').asString := FieldValues['iNumeroEstimacion'];
            connection.zCommand.Params.ParamByName('Generador').asString  := FieldValues['sNumeroGenerador'];
            connection.zCommand.Params.ParamByName('Status').asString     := 'Validado';
            connection.zCommand.Params.ParamByName('Avance').AsFloat      := dFinancieroGenerador;
            connection.zCommand.Params.ParamByName('MontoMN').AsFloat     := dMontoMN;
            connection.zCommand.Params.ParamByName('MontoDLL').AsFloat    := dMontoDLL;
            connection.zCommand.Params.ParamByName('Valida').asString     := global_valida;
            connection.zCommand.ExecSQL();
        ...
        begin
          ...
          begin
            ...
            QryReporteNoValidado.Params.ParamByName('contrato').asString := global_contrato;

            QryReporteNoValidado.Params.ParamByName('Orden').asString := Estimaciones.FieldValues['sNumeroOrden'];
                    ...
                    begin
                      ...
                      begin
                        ...
                        if connection.configuracion.FieldValues['sBaseGeneracion'] = 'Contrato Original' then
                          Connection.QryBusca2.Params.ParamByName('convenio').asString := ''
                        else
                          Connection.QryBusca2.Params.ParamByName('convenio').asString := global_convenio;
                        Connection.QryBusca2.Params.ParamByName('actividad').DataType := ftString;
                        Connection.QryBusca2.Params.ParamByName('Actividad').asString := connection.QryBusca.FieldValues['sNumeroActividad'];
                        Connection.QryBusca2.Open;
                      ...
                      if ((dPartidaGenerado + connection.QryBusca.FieldValues['dCantidad']) > dPartidaAnexo) then
                        ...
                        begin
                          ...
                          connection.zCommand.Params.ParamByName('wbs').asString := connection.QryBusca.FieldValues['sWbs'];
                          connection.zCommand.Params.ParamByName('actividad').DataType := ftString;
                          connection.zCommand.Params.ParamByName('Actividad').asString := connection.QryBusca.FieldValues['sNumeroActividad'];
     ...
     ;                      connection.QryBusca2.Params.ParamByName('contrato').asString := global_contrato;
                            connection.QryBusca2.Params.ParamByName('Orden').asString := fieldvalues['sNumeroOrden'];
                            connection.QryBusca2.Params.ParamByName('generador').DataType := ftString;
                            connection.QryBusca2.Params.ParamByName('generador').asString := fieldvalues['sNumeroGenerador'] + sPrefijo;
                            connection.QryBusca2.Open;
                            if connection.QryBusca2.recordcount = 0 then
                            begin
                            ...
                            connection.zCommand.Params.ParamByName('contrato').asString := fieldvalues['sContrato'];
                            connection.zCommand.Params.ParamByName('Orden').DataType := ftString;
                            connection.zCommand.Params.ParamByName('Orden').asString := fieldvalues['sNumeroOrden'];
                            connection.zCommand.Params.ParamByName('Generador').DataType := ftString;
                            connection.zCommand.Params.ParamByName('generador').asString := fieldvalues['sNumeroGenerador'] + sPrefijo;
                            connection.zCommand.Params.ParamByName('wbs').DataType := ftString;
                            connection.zCommand.Params.ParamByName('wbs').asString := connection.QryBusca.fieldvalues['sWbs'];
                            connection.zCommand.Params.ParamByName('Actividad').DataType := ftString;
                            connection.zCommand.Params.ParamByName('Actividad').asString := connection.QryBusca.fieldvalues['sNumeroActividad'];
                        ...
                        if iResp = 1 then
                          ...
                          if iResp = 0 then
                            ...
                            begin
                              ...
                              connection.QryBusca.Params.ParamByName('fecha').asDate := Estimaciones.FieldValues['dFechaFinal'];
                              connection.QryBusca.Open;
                              if connection.QryBusca.RecordCount = 0 then
                              begin
                              ...
                              begin
                                ...
                                connection.QryBusca.Params.ParamByName('contrato').asString := global_contrato;
                                connection.QryBusca.Params.ParamByName('Actividad').asString := connection.QryBusca.FieldValues['sNumeroActividad'];
                                connection.QryBusca.Open;
                                if connection.QryBusca.RecordCount > 0 then
                ...
                begin
                  ...
                  connection.qryBusca.Params.ParamByName('convenio').asString  := Global_Convenio;
                  connection.qryBusca.Params.ParamByName('Orden').asString     := FieldValues['sNumeroOrden'];
                  connection.qryBusca.Params.ParamByName('generador').asString := FieldValues['sNumeroGenerador'];
                  Connection.qryBusca.Open;
...
begin
  ...
  Requisicion.ParamByName('contrato').asString := global_contrato;
  Requisicion.Open;

  OrdenCompra.Active := False;
  OrdenCompra.ParamByName('Contrato').DataType := ftString;
  OrdenCompra.ParamByName('contrato').asString := global_contrato;
  OrdenCompra.Open;

  QrySalida.Active := False;
  QrySalida.ParamByName('Contrato').DataType := ftString;
  QrySalida.ParamByName('contrato').asString := global_contrato;
  QrySalida.Open;
  ...
  EstimacionPeriodo.Params.ParamByName('contrato').asString := global_contrato;
  EstimacionPeriodo.Open;

  Estimaciones.Active := False;
  Estimaciones.Params.ParamByName('contrato').DataType := ftString;
  Estimaciones.Params.ParamByName('contrato').asString := global_contrato;
  Estimaciones.Open;
  ...
  begin
    ...
    OrdenesdeTrabajo.Params.ParamByName('contrato').asString := Global_Contrato;
    OrdenesdeTrabajo.Params.ParamByName('orden').DataType := ftString;
    OrdenesdeTrabajo.Params.ParamByName('Orden').asString := global_orden_general;
  ...
  begin
    ...
    ReporteDiario.Params.ParamByName('contrato').asString := global_contrato;
...
var
  ...
  begin
    try
      ...
      connection.CommandTrx.Params.ParamByName('contrato').asString := sParamContrato;
      ...
      connection.CommandTrx.Params.ParamByName('fecha').asDate := dParamFecha;
      ...
      qryBusca.Params.ParamByName('contrato').asString := sParamContrato;
      qryBusca.Params.ParamByName('Fecha').DataType := ftDate;
      qryBusca.Params.ParamByName('fecha').asDate := dParamFecha;
      qryBusca.Params.ParamByName('Orden').DataType := ftString;
      qryBusca.Params.ParamByName('Orden').asString := 'CONTRATO NO. ' + sParamContrato;
      qryBusca.Open;
      ...
      begin
        ...
        begin
          ...
          qryBusca2.Params.ParamByName('contrato').asString := sParamContrato;
          qryBusca2.Params.ParamByName('Fecha').DataType := ftDate;
          qryBusca2.Params.ParamByName('fecha').asDate := dParamFecha;
          qryBusca2.Params.ParamByName('Orden').DataType := ftString;
          qryBusca2.Params.ParamByName('Orden').asString := qryBusca.FieldValues['sNumeroOrden'];
          qryBusca2.Open;
          StringListxOrden.Clear;
          ...
          connection.CommandTrx.Params.ParamByName('Orden').asString := qryBusca.FieldValues['sNumeroOrden'];
      ...
      begin
        ...
        qryBusca.Params.ParamByName('fecha').asDate := dParamFecha;
        qryBusca.Params.ParamByName('Orden').DataType := ftString;
        qryBusca.Params.ParamByName('Orden').asString := sParamOrden;
        qryBusca.Open;
        if qryBusca.RecordCount > 0 then
        begin
          if global_title_embarque = '' then
          ...
          connection.CommandTrx.Params.ParamByName('Depto').Value := global_depto;
          connection.CommandTrx.Params.ParamByName('Orden').DataType := ftString;
          connection.CommandTrx.Params.ParamByName('Orden').asString := sParamOrden;
          connection.CommandTrx.Params.ParamByName('Tipo').DataType := ftString;
          connection.CommandTrx.Params.ParamByName('Tipo').Value := 'AE';
          connection.CommandTrx.Params.ParamByName('Descripcion').DataType := ftMemo;
...
begin
  MdDatos:=TdxMemData.Create(self);
  try
    ...
    try
      ...
      begin
        ...
        if lPoder then
        begin
          if MdDatos.Active then
          begin
            MdDatos.Close;

            for iGrid := MdDatos.Fields.Count - 1 downto 0 do
              if MdDatos.Fields[iGrid].FieldName = 'RecId' then
                continue
              else
              begin
                AField := MdDatos.Fields[iGrid];
                MdDatos.Fields.Remove(AField);
                AField.Free;
              end;
          end;
          ...
          with Grid_requisicion.DataSource.DataSet do
            ...
            begin
              ...
              begin
                ...
                if not MdDatos.Active then
                begin
                  MdDatos.CreateFieldsFromDataSet(Grid_requisicion.DataSource.DataSet);
                  MdDatos.Open;
                end;
                MdDatos.Append;
                MdDatos.CopyFields(Grid_requisicion.DataSource.DataSet);
                MdDatos.Post;
          ...
          begin
            ...
            begin
              Application.CreateForm(TFrmExportPdf,FrmExportPdf);
              try
                FrmExportPdf.MdDatos:=MdDatos;
                FrmExportPdf.Tipo:=DcReCo;
                FrmExportPdf.ShowModal;

                DirFiles:=FrmExportPdf.DirTmp;
                sFiles:=FrmExportPdf.CadFile;

              finally
                FrmExportPdf.Destroy;
              end;

              if (DirFiles<>'') and (sFiles<>'') then
              begin
                Application.CreateForm(TFrmSendMail,FrmSendMail);
                try
                  FrmSendMail.DirFiles:=DirFiles;
                  FrmSendMail.sFiles:=sFiles;
                  FrmSendMail.Tipo:=DcReCo;
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  if not MdDatos.Active then
                  begin
                    MdDatos.CreateFieldsFromDataSet(Grid_OrdenCompra.DataSource.DataSet);
                    MdDatos.Open;
                  end;
                  MdDatos.Append;
                  MdDatos.CopyFields(Grid_OrdenCompra.DataSource.DataSet);
                  MdDatos.Post;
          ...
          with Grid_reportes.DataSource.DataSet do
            ...
            begin
              ...
              begin
                ...
                QryBusca.Params.ParamByName('Contrato').DataType := ftString;
                QryBusca.Params.ParamByName('contrato').asString := Global_Contrato;
                QryBusca.Params.ParamByName('Fecha').DataType := ftDate;
                QryBusca.Params.ParamByName('fecha').asDate := ReporteDiario.FieldValues['dIdFecha'];
                QryBusca.Params.ParamByName('Orden').DataType := ftString;
                QryBusca.Params.ParamByName('Orden').asString := tsNumeroOrden.KeyValue;
                ...
                begin
                  ...
                  begin
                    try
                      ...
                      connection.CommandTrx.ParamByName('Orden').asString := QryBusca.FieldValues['sNumeroOrden'];
                ...
                connection.CommandTrx.SQL.Add('Update reportediario SET lStatus = :Status , sIdUsuarioAutoriza = :Valida , sIdUsuarioResidente = :Residente ' +
                  'Where sContrato = :Contrato And sNumeroOrden = :Orden And dIdFecha = :fecha And sIdTurno = :Turno');
                connection.CommandTrx.Params.ParamByName('Contrato').DataType := ftString;
                connection.CommandTrx.Params.ParamByName('contrato').asString := Global_Contrato;
                connection.CommandTrx.Params.ParamByName('Orden').DataType := ftString;
                connection.CommandTrx.Params.ParamByName('Orden').asString := FieldValues['sNumeroOrden'];
                connection.CommandTrx.Params.ParamByName('Fecha').DataType := ftDate;
                connection.CommandTrx.Params.ParamByName('fecha').asDate := FieldValues['dIdFecha'];
                connection.CommandTrx.Params.ParamByName('Turno').DataType := ftString;
                ...
                connection.CommandTrx.Params.ParamByName('Usuario').Value := Global_Usuario;
                connection.CommandTrx.Params.ParamByName('Fecha').DataType := ftDate;
                connection.CommandTrx.Params.ParamByName('fecha').asDate := Date;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                connection.CommandTrx.Params.ParamByName('generador').asString := FieldValues['sNumeroGenerador'];
                connection.CommandTrx.Params.ParamByName('Status').DataType := ftString;
                connection.CommandTrx.Params.ParamByName('Status').Value := 'Autorizado';
                connection.CommandTrx.Params.ParamByName('Valida').DataType := ftString;
                connection.CommandTrx.Params.ParamByName('Valida').Value := global_autoriza;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                QryBusca2.Params.ParamByName('contrato').asString   := global_contrato ;
                QryBusca2.Params.ParamByName('Estimacion').asString := EstimacionPeriodo.FieldValues['iNumeroEstimacion'];
                QryBusca2.Open;
                while not QryBusca2.Eof do
                begin
                  QryBusca.Active := False;
                  ...
                  QryBusca.Params.ParamByName('contrato').asString   := global_contrato;
                  QryBusca.Params.ParamByName('Estimacion').asString := EstimacionPeriodo.FieldValues['iNumeroEstimacion'];
                  QryBusca.Params.ParamByName('Paquete').asString    := QryBusca2.FieldValues['sWBS'];
                  QryBusca.Open;
                  if QryBusca.RecordCount > 0 then
                  begin
                    connection.CommandTrx.Active := False;
                    ...
                    connection.CommandTrx.params.ParamByName('contrato').asString        := global_contrato;
                    connection.CommandTrx.params.ParamByName('Estimacion').asString      := EstimacionPeriodo.FieldValues['iNumeroEstimacion'];
                    connection.CommandTrx.params.ParamByName('Paquete').asString         := QryBusca2.FieldValues['sWBS'];
                    connection.CommandTrx.params.ParamByName('MontoAnteriorMN').asFloat  := QryBusca.FieldValues['dMontoAnteriorMN'];
                    connection.CommandTrx.params.ParamByName('MontoMN').asFloat          := QryBusca.FieldValues['dMontoMN'];
                    connection.CommandTrx.params.ParamByName('AcumuladoMN').asFloat      := roundto(QryBusca.FieldValues['dMontoAnteriorMN'], -2) + roundto(QryBusca.FieldValues['dMontoMN'], -2);
                    connection.CommandTrx.params.ParamByName('MontoAnteriorDLL').asFloat := QryBusca.FieldValues['dMontoAnteriorDLL'];
                    connection.CommandTrx.params.ParamByName('MontoDLL').asFloat         := QryBusca.FieldValues['dMontoDLL'];
                    connection.CommandTrx.params.ParamByName('AcumuladoDLL').asFloat     := QryBusca.FieldValues['dMontoAnteriorDLL'] + QryBusca.FieldValues['dMontoDLL'];
                    Connection.CommandTrx.ExecSQL;
                  end;
                  QryBusca2.Next
                end;
                ...
                Connection.CommandTrx.Params.ParamByName('contrato').asString     := global_contrato;
                Connection.CommandTrx.Params.ParamByName('Estimacion').asString   := EstimacionPeriodo.FieldValues['iNumeroEstimacion'];
                Connection.CommandTrx.Params.ParamByName('GeneradorMN').asFloat   := dMontoGeneradoMN;
                Connection.CommandTrx.Params.ParamByName('GeneradorDLL').asFloat  := dMontoGeneradoDLL;
                Connection.CommandTrx.Params.ParamByName('EstimacionMN').asFloat  := dMontoEstimacionMN;
                Connection.CommandTrx.Params.ParamByName('EstimacionDLL').asFloat := dMontoEstimacionDLL;
                Connection.CommandTrx.Params.ParamByName('dMontoAcumMN').asFloat  := dMontoEstimacionAcumMN;
                Connection.CommandTrx.Params.ParamByName('dMontoAcumDLL').asFloat := dMontoEstimacionAcumDLL;
                Connection.CommandTrx.Params.ParamByName('Usuario').asString      := global_autoriza;
                Connection.CommandTrx.ExecSQL;
...
begin
  ...
  connection.qryBusca.Params.ParamByName('contrato').asString := ReporteDiario.FieldValues['sContrato'];
  connection.qryBusca.Params.ParamByName('convenio').asString := ReporteDiario.FieldValues['sIdConvenio'];
  Connection.qryBusca.Open;
  if Connection.qryBusca.RecordCount > 0 then
...
begin
  ...
  begin
    ...
    connection.qryBusca.Params.ParamByName('contrato').asString    := global_contrato;
    connection.qryBusca.Params.ParamByName('Orden').asString       := Estimaciones.FieldValues['sNumeroOrden'];
    connection.qryBusca.Params.ParamByName('generador').asString   := Estimaciones.FieldValues['sNumeroGenerador'];
    connection.qryBusca.Params.ParamByName('Actividad').asString   := Estimaciones.FieldValues['sNumeroActividad'];
    connection.qryBusca.Params.ParamByName('Referencia').AsString  := Estimaciones.FieldValues['sIsometricoReferencia'];
    Connection.qryBusca.Open;
    while not Connection.qryBusca.Eof do
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            Q_Actualiza.Params.ParamByName('Orden').asString    := dParamOrden;
            Q_Actualiza.Params.ParamByName('convenio').asString := dParamConvenio;
            Q_Actualiza.Params.ParamByName('fecha').asDate      := dParamFecha;
            Q_Actualiza.Params.ParamByName('wbs').asString      := Q_BuscaPaquete.FieldValues['sWbs'];
            if Avance < Q_BuscaAvance.FieldValues['dAvance'] then
              Q_Actualiza.Params.ParamByName('Avance').asFloat  := Q_BuscaPaquete.FieldValues['dAvance'] + diferencia
            else
              Q_Actualiza.Params.ParamByName('Avance').asFloat  := Q_BuscaPaquete.FieldValues['dAvance'] - diferencia;
            Q_Actualiza.ExecSQL;
          end;
